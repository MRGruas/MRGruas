...
!(function (t, e) {
  ...
  (e =
    e && Object.prototype.hasOwnProperty.call(e, 'default')
      ? e.default
      : e), (n = n && Object.prototype.hasOwnProperty.call(n, 'default') ? n.default : n)
  function l (t) {
    var n = this
    var i = !1
  ...
  var c = {
    ...
    getTransitionDurationFromElement: function (t) {
      ...
      var i = e(t).css('transition-delay')
      var o = parseFloat(n)
      var s = parseFloat(i)
      return o || s
        ? (
  ...
  c.jQueryDetection(), (e.fn.emulateTransitionEnd = l), (e.event.special[
    c.TRANSITION_END
  ] = {
  ...
  var d = (function () {
    ...
    return (n.close = function (t) {
      ...
      var i = !1
      return n && (i = document.querySelector(n)), i ||
          (i = e(t).closest('.alert')[0]), i
  ...
  ), (e.fn[h] = d._jQueryInterface), (e.fn[h].Constructor = d), (e.fn[
    h
  ].noConflict = function () {
  ...
  var g = (function () {
    ...
    return (n.toggle = function () {
      var t = !0
      var n = !0
      var i = e(this._element).closest('[data-toggle="buttons"]')[0]
      if (i) {
  ...
  e(document)
    ...
    g._jQueryInterface), (e.fn.button.Constructor = g), (e.fn.button.noConflict = function () {
  ...
  var E = (function () {
    ...
    return (n.next = function () {
      ...
      e(this._element).off(p), e.removeData(
        this._element,
        'bs.carousel'
        ...
        var i = function (e) {
          t._pointerEvent &&
                ...
                (t.touchDeltaX =
                  ...
                  t.touchStartX), t._handleSwipe(), t._config.pause ===
                'hover' &&
                (
                  t.pause(),
      ...
      var r = (o + (t === 'prev' ? -1 : 1)) % this._items.length
      return r === -1 ? this._items[this._items.length - 1] : this._items[r]
    }), (n._triggerSlideEvent = function (t, n) {
      var i = this._getItemIndex(t)
      var o = this._getItemIndex(
        this._element.querySelector('.active.carousel-item')
      )
      var s = e.Event('slide.bs.carousel', {
        relatedTarget: t,
        direction: n,
        from: o,
        to: i,
      ...
      var s
      var r = this
      var a = this._element.querySelector('.active.carousel-item')
      var l = this._getItemIndex(a)
      var h = n || (a && this._getItemByDirection(t, a))
      var u = this._getItemIndex(h)
          ...
          e(a)
            .one(c.TRANSITION_END, function () {
              e(h)
                ...
                .addClass(
                  'active'
                ), e(a).removeClass('active ' + o + ' ' + i), (r._isSliding = !1), setTimeout(function () {
                return e(r._element).trigger(f)
              }, 0)
            })
            .emulateTransitionEnd(m)
        } else {
          e(a).removeClass('active'), e(h).addClass(
            'active'
      ...
      return this.each(function () {
        ...
        var o = a(a({}, v), e(this).data())
        typeof n === 'object' && (o = a(a({}, o), n))
      ...
      if (i) {
        ...
        if (o && e(o).hasClass('carousel')) {
          ...
          r && (s.interval = !1), t._jQueryInterface.call(e(o), s), r &&
              e(o).data('bs.carousel').to(r), n.preventDefault()
        }
      }
    }), o(t, null, [
      {
  ...
  }), (e.fn[m] = E._jQueryInterface), (e.fn[m].Constructor = E), (e.fn[
    m
  ].noConflict = function () {
  ...
  var w = 'collapse'
  var T = e.fn[w]
  var C = { toggle: !0, parent: '' }
  var S = { toggle: 'boolean', parent: '(string|element)' }
  var D = (function () {
    function t (t, e) {
      ...
      for (
        ...
        var s = n[i]
        var r = c.getSelectorFromElement(s)
        var a = [].slice.call(document.querySelectorAll(r)).filter(function (e) {
          return e === t
        })
        r !== null &&
            a.length > 0 &&
    ...
    return (n.toggle = function () {
      ...
      if (
        ...
        if ((e(this._element).trigger(s), !s.isDefaultPrevented())) {
          ...
          e(this._element)
            ...
            .addClass('collapsing'), (this._element.style[r] = 0), this
          ...
          e(this._element)
            .one(c.TRANSITION_END, function () {
              e(o._element)
                ...
                .addClass(
                  'collapse show'
                ), (o._element.style[r] = ''), o.setTransitioning(!1), e(o._element).trigger('shown.bs.collapse')
            })
            .emulateTransitionEnd(l), (this._element.style[r] =
              this._element[a] + 'px')
        }
      }
    }), (n.hide = function () {
      ...
      if (!this._isTransitioning && e(this._element).hasClass('show')) {
        ...
        if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
          ...
          (this._element.style[i] =
              this._element.getBoundingClientRect()[i] + 'px'), c.reflow(
            this._element
          ), e(this._element)
            .addClass('collapsing')
          ...
          if (o > 0) {
            for (var s = 0; s < o; s++) {
              ...
              var a = c.getSelectorFromElement(r)
              if (a !== null) {
      ...
      return ((t = a(a({}, C), t)).toggle = Boolean(
        t.toggle
      )), c.typeCheckConfig(w, t, S), t
      ...
      var o =
            ...
            this._config.parent +
            '"]'
      var s = [].slice.call(n.querySelectorAll(o))
      ...
      return this.each(function () {
        ...
        var s = a(a(a({}, C), i.data()), typeof n === 'object' && n ? n : {})
        if (
          (
            !o &&
                s.toggle &&
  ...
  e(
    ...
    e(o).each(function () {
      var t = e(this)
      var i = t.data('bs.collapse') ? 'toggle' : n.data()
      D._jQueryInterface.call(t, i)
    })
  }), (e.fn[w] = D._jQueryInterface), (e.fn[w].Constructor = D), (e.fn[
    w
  ].noConflict = function () {
  ...
  var j = (function () {
    ...
    return (i.toggle = function () {
      ...
      if (
        ...
        var s = e.Event('show.bs.dropdown', o)
        ...
        if ((e(r).trigger(s), !s.isDefaultPrevented())) {
          if (!this._inNavbar && i) {
            ...
            this._config.reference === 'parent'
              ...
              : c.isElement(this._config.reference) &&
                ...
                e(r).addClass('position-static'), (this._popper = new n(
              a,
              this._menu,
          ...
          'ontouchstart' in document.documentElement &&
            ...
            'aria-expanded',
            !0
          ), e(this._menu).toggleClass('show'), e(r)
            .toggleClass('show')
      ...
      if (
        ...
        var i = e.Event('hide.bs.dropdown', n)
        var o = t._getParentFromElement(this._element)
        e(o).trigger(i), i.isDefaultPrevented() ||
            (
      ...
      e.removeData(this._element, 'bs.dropdown'), e(this._element).off(
        '.bs.dropdown'
      ), (this._element = null), (this._menu = null), this._popper !== null &&
          (this._popper.destroy(), (this._popper = null))
    }), (i.update = function () {
      (this._inNavbar = this._detectNavbar()), this._popper !== null &&
      ...
      return (t = a(
        ...
        t
      )), c.typeCheckConfig(k, t, this.constructor.DefaultType), t
      ...
      var t = this
      var e = {}
      return typeof this._config.offset === 'function'
        ? (e.fn = function (e) {
          return (e.offsets = a(
            a({}, e.offsets),
      ...
      return this._config.display === 'static' &&
      ...
      if (!n || (n.which !== 3 && (n.type !== 'keyup' || n.which === 9))) {
        for (
          ...
          var a = e(i[o]).data('bs.dropdown')
          var l = { relatedTarget: i[o] }
          if ((n && n.type === 'click' && (l.clickEvent = n), a)) {
            ...
            if (
              ...
              e(r).trigger(h), h.isDefaultPrevented() ||
                  (
                    'ontouchstart' in document.documentElement &&
                      e(document.body)
                        .children()
  ...
  e(document)
    ...
    .on('click.bs.dropdown.data-api', '.dropdown form', function (t) {
      t.stopPropagation()
    }), (e.fn[k] = j._jQueryInterface), (e.fn[k].Constructor = j), (e.fn[
    k
  ].noConflict = function () {
    return (e.fn[k] = N), j._jQueryInterface
  })
  var P = e.fn.modal
  var x = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }
  var L = {
  ...
  var R = (function () {
    ...
    return (n.toggle = function (t) {
      ...
      if (!this._isShown && !this._isTransitioning) {
        ...
        e(this._element).trigger(i), this._isShown ||
            ...
            (
              ...
              e(
                this._element
              ).on('click.dismiss.bs.modal', '[data-dismiss="modal"]', function (
                t
              ) {
                return n.hide(t)
              }),
      ...
      }), e(document).off('focusin.bs.modal'), e.removeData(
        this._element,
        'bs.modal'
      ...
      var o = this._dialog ? this._dialog.querySelector('.modal-body') : null;
      (this._element.parentNode &&
        ...
        'aria-hidden'
      ), this._element.setAttribute('aria-modal', !0), e(
        this._dialog
      ).hasClass('modal-dialog-scrollable') && o
        ? (o.scrollTop = 0)
        : (this._element.scrollTop = 0), i && c.reflow(this._element), e(
        this._element
      ).addClass('show'), this._config.focus && this._enforceFocus()
      var s = e.Event('shown.bs.modal', { relatedTarget: t })
      var r = function () {
        n._config.focus && n._element.focus(), (n._isTransitioning = !1), e(
          n._element
        ).trigger(s)
      }
      if (i) {
      ...
      var n = this
      var i = e(this._element).hasClass('fade') ? 'fade' : ''
      ...
      if (this._isBodyOverflowing) {
        ...
        e(n).each(function (n, i) {
          ...
          var s = e(i).css('padding-right')
          e(i)
            .data('padding-right', o)
            .css('padding-right', parseFloat(s) + t._scrollbarWidth + 'px')
        }), e(i).each(function (n, i) {
          var o = i.style.marginRight
          var s = e(i).css('margin-right')
          e(i)
            .data('margin-right', o)
            .css('margin-right', parseFloat(s) - t._scrollbarWidth + 'px')
        })
        var o = document.body.style.paddingRight
        var s = e(document.body).css('padding-right')
        e(document.body)
          .data('padding-right', o)
  ...
  var Q = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/gi
  var B = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i
  function H (t, e, n) {
    if (t.length === 0) {
      return t
    }
  ...
  var U = 'tooltip'
  var M = e.fn[U]
  var W = new RegExp('(^|\\s)bs-tooltip\\S+', 'g')
  var V = ['sanitize', 'whiteList', 'sanitizeFn']
  var z = {
    animation: 'boolean',
    template: 'string',
    ...
    return (i.enable = function () {
      ...
      if (this._isEnabled) {
        if (t) {
          ...
          var i = e(t.currentTarget).data(n)
          i ||
              (
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        var a = c.getUID(this.constructor.NAME)
        r.setAttribute('id', a), this.element.setAttribute(
          'aria-describedby',
          a
        ), this.setContent(), this.config.animation && e(r).addClass('fade')
        var l =
        ...
        e(r).data(this.constructor.DATA_KEY, this), e.contains(
          this.element.ownerDocument.documentElement,
          this.tip
        ) || e(r).appendTo(u), e(this.element).trigger(
          this.constructor.Event.INSERTED
        ), (this._popper = new n(
          this.element,
          r,
          this._getPopperConfig(h)
        )), e(r).addClass('show'), 'ontouchstart' in
      ...
      var o = e.Event(this.constructor.Event.HIDE)
      var s = function () {
        n._hoverState !== 'show' &&
              i.parentNode &&
          ...
          'aria-describedby'
        ), e(n.element).trigger(n.constructor.Event.HIDDEN), n._popper !==
              null && n._popper.destroy(), t && t()
      }
      ...
      var t = this
      var e = {}
      return typeof this.config.offset === 'function'
        ? (e.fn = function (e) {
          return (e.offsets = a(
            a({}, e.offsets),
      ...
      (n = n || e(t.currentTarget).data(i)) ||
          ...
          (n._activeTrigger[t.type === 'focusin' ? 'focus' : 'hover'] = !0), e(
        n.getTipElement()
      ).hasClass('show') || n._hoverState === 'show'
        ? (n._hoverState = 'show')
        : (
      ...
      return Object.keys(n).forEach(function (t) {
        V.indexOf(t) !== -1 && delete n[t]
      }), typeof (t = a(
        a(a({}, this.constructor.Default), n),
        typeof t === 'object' && t ? t : {}
      )).delay ===
          'number' && (t.delay = { show: t.delay, hide: t.delay }), typeof t.title ===
          'number' && (t.title = t.title.toString()), typeof t.content ===
          'number' &&
          (t.content = t.content.toString()), c.typeCheckConfig(
        U,
        t,
  ...
  (e.fn[U] = $._jQueryInterface), (e.fn[U].Constructor = $), (e.fn[
    U
  ].noConflict = function () {
  ...
  var J = 'popover'
  var G = e.fn[J]
  var Z = new RegExp('(^|\\s)bs-popover\\S+', 'g')
  var tt = a(
    a({}, $.Default),
    {},
    {
  ...
  var et = a(a({}, $.DefaultType), {}, { content: '(string|element|function)' })
  var nt = {
  ...
  var it = (function (t) {
    ...
    (i = t), ((n = s).prototype = Object.create(
      i.prototype
    ...
    return (r.isWithContent = function () {
      ...
      var t = e(this.getTipElement())
      var n = t.attr('class').match(Z)
      n !== null && n.length > 0 && t.removeClass(n.join(''))
    }), (s._jQueryInterface = function (t) {
      return this.each(function () {
        var n = e(this).data('bs.popover')
        var i = typeof t === 'object' ? t : null
        if (
  ...
  (e.fn[J] = it._jQueryInterface), (e.fn[J].Constructor = it), (e.fn[
    J
  ].noConflict = function () {
  ...
  var ot = 'scrollspy'
  var st = e.fn[ot]
  var rt = { offset: 10, method: 'auto', target: '' }
  var at = { offset: 'number', method: 'string', target: '(string|element)' }
  var lt = (function () {
    function t (t, n) {
      var i = this;
      (this._element = t), (this._scrollElement =
          t.tagName === 'BODY' ? window : t), (this._config = this._getConfig(
        n
      )), (this._selector =
          this._config.target +
          ' .nav-link,' +
          ...
          ' .list-group-item,' +
          this._config.target +
          ' .dropdown-item'), (this._offsets = []), (this._targets = []), (this._activeTarget = null), (this._scrollHeight = 0), e(
        this._scrollElement
    ...
    return (n.refresh = function () {
      ...
      if (
        typeof (t = a(a({}, rt), typeof t === 'object' && t ? t : {}))
          .target !==
            'string' &&
          c.isElement(t.target)
      ) {
        var n = e(t.target).attr('id')
        n || ((n = c.getUID(ot)), e(t.target).attr('id', n)), (t.target =
            '#' + n)
      }
  ...
  }), (e.fn[ot] = lt._jQueryInterface), (e.fn[ot].Constructor = lt), (e.fn[
    ot
  ].noConflict = function () {
  ...
  var ht = (function () {
    ...
    return (n.show = function () {
      ...
      if (
        ...
        var n
        var i
        var o = e(this._element).closest('.nav, .list-group')[0]
        var s = c.getSelectorFromElement(this._element)
        if (o) {
          var r =
        ...
        var l = e.Event('show.bs.tab', { relatedTarget: i })
        if (
          (
            i && e(i).trigger(a),
          ...
          s && (n = document.querySelector(s)), this._activate(
            this._element,
            o
          )
          var h = function () {
            var n = e.Event('hidden.bs.tab', { relatedTarget: t._element })
            var o = e.Event('shown.bs.tab', { relatedTarget: i })
      ...
      var o = this
      var s = (!n || (n.nodeName !== 'UL' && n.nodeName !== 'OL')
        ? e(n).children('.active')
        : e(n).find('> li > .active'))[0]
      var r = i && s && e(s).hasClass('fade')
      var a = function () {
      ...
      if (n) {
        ...
        o && e(o).removeClass('active'), n.getAttribute('role') === 'tab' &&
  ...
  var ut = e.fn.toast
  var dt = { animation: 'boolean', autohide: 'boolean', delay: 'number' }
  var ft = { animation: !0, autohide: !0, delay: 500 }
  var gt = (function () {
    function t (t, e) {
    ...
    return (n.show = function () {
      var t = this
      var n = e.Event('show.bs.toast')
      if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
        this._config.animation && this._element.classList.add('fade')
        var i = function () {
          t._element.classList.remove('showing'), t._element.classList.add(
            'show'
          ), e(t._element).trigger('shown.bs.toast'), t._config.autohide &&
      ...
      clearTimeout(
        this._timeout
      ), (this._timeout = null), this._element.classList.contains('show') &&
          this._element.classList.remove('show'), e(this._element).off(
      ...
      return (t = a(
        ...
        typeof t === 'object' && t ? t : {}
      )), c.typeCheckConfig('toast', t, this.constructor.DefaultType), t
      ...
      var t = this
      var n = function () {
        t._element.classList.add('hide'), e(t._element).trigger(
          'hidden.bs.toast'
        )
      }
  ...
  (e.fn.toast =
    gt._jQueryInterface), (e.fn.toast.Constructor = gt), (e.fn.toast.noConflict = function () {

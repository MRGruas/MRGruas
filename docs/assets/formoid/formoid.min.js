jQuery(function ($) {
  var Formoid = (function () {
    var API_URL = (location.protocol == 'https:' ? 'https:' : 'http:') + '//formoid.net/api/push'

    var $ajax = (function () {
      var ie = (/MSIE (\d+)\./.exec(navigator.userAgent) || [0, 0])[1]
      if (ie == 8 || (ie == 9 && location.protocol != 'file:')) {
        return function (url, settings) {
          var xdr = new XDomainRequest(); var defer = $.Deferred()
  ...
  $('[data-form-type="formoid"]').each(function () {
    ...
    var $alert = $this.find('[data-form-alert]')
    var $title = $this.is('[data-form-title]') ? $this : $this.find('[data-form-title]')
    var $submit = $this.find('[type="submit"]')
    var $inputArr = $form.find('[data-form-field]')
    var alertSuccess = $alert.html()
        ...
        inputs.each(function (index, input) {
          ...
          switch (typeInput) {
            case 'file': {
              ...
              var name = $input.attr('data-form-field') || $input.attr('name')

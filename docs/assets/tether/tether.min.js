!(function(t, e) {
            ...
            if ("undefined" != typeof this.bindings && this.bindings[t]) {
              ...
              for (; e < this.bindings[t].length; ) {
                var r = this.bindings[t][e],
                  ...
                  f = r.once,
                  h = a;
                "undefined" == typeof h && (h = this), s.apply(h, i), f
  ...
  var z = { center: "center", left: "right", right: "left" },
    ...
    H = function(t) {
      var e = t.left,
        o = t.top;
      return "undefined" != typeof L[t.left] && (e = L[t.left]), "undefined" !=
        typeof L[t.top] && (o = L[t.top]), { left: e, top: o };
    },
    X = function(t) {
      var e = t.split(" "),
        o = M(e, 2),
        ...
        },
        {
          ...
          value: function() {
            h(this.target, this.getClass("enabled")), h(
              this.element,
              this.getClass("enabled")
            ), (this.enabled = !1), "undefined" != typeof this.scrollParent &&
                ...
                d = function(t, o) {
                  ...
                  if (n !== !1) {
                    ...
                    t.top
                      ...
                      "px) translateY(" +
                      Math.round(r) +
                      "px)"), "msTransform" !== k && (l[k] += " translateZ(0)");
                  } else
                    t.top
                      ? (l.top = o.top + "px")
    ...
    position: function(t) {
      ...
      return this.options.constraints.forEach(function(t) {
        ...
        ("target" === d || "both" === d) &&
          ...
          ), "together" === d && (o < w[1] && "top" === v.top && ("bottom" === y.top ? ((o += u), (v.top = "bottom"), (o += a), (y.top = "top")) : "top" === y.top && ((o += u), (v.top = "bottom"), (o -= a), (y.top = "bottom"))), o + a > w[3] && "bottom" === v.top && ("top" === y.top ? ((o -= u), (v.top = "top"), (o -= a), (y.top = "bottom")) : "bottom" === y.top && ((o -= u), (v.top = "top"), (o += a), (y.top = "top"))), "middle" === v.top && (o + a > w[3] && "top" === y.top ? ((o -= a), (y.top = "bottom")) : o < w[1] && "bottom" === y.top && ((o += a), (y.top = "top")))), ("target" === l || "both" === l) && (i < w[0] && "left" === v.left && ((i += p), (v.left = "right")), i + h > w[2] && "right" === v.left && ((i -= p), (v.left = "left"))), "together" === l && (i < w[0] && "left" === v.left ? ("right" === y.left ? ((i += p), (v.left = "right"), (i += h), (y.left = "left")) : "left" === y.left && ((i += p), (v.left = "right"), (i -= h), (y.left = "right"))) : i + h > w[2] && "right" === v.left ? ("left" === y.left ? ((i -= p), (v.left = "left"), (i -= h), (y.left = "right")) : "right" === y.left && ((i -= p), (v.left = "left"), (i += h), (y.left = "left"))) : "center" === v.left && (i + h > w[2] && "left" === y.left ? ((i -= h), (y.left = "right")) : i < w[0] && "right" === y.left && ((i += h), (y.left = "left")))), ("element" === d || "both" === d) && (o < w[1] && "bottom" === y.top && ((o += a), (y.top = "top")), o + a > w[3] && "top" === y.top && ((o -= a), (y.top = "bottom"))), ("element" === l || "both" === l) && (i < w[0] && "right" === y.left && ((i += h), (y.left = "left")), i + h > w[2] && "left" === y.left && ((i -= h), (y.left = "right"))), "string" ==
        typeof f

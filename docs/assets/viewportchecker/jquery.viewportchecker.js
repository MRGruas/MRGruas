...
!(function (b) {
  b.fn.viewportChecker = function (n) {
    ...
    b.extend(e, n)
    var g = this
    var k = b(e.scrollBox).height()
    var p = b(e.scrollBox).width()
    return (this.checkElements = function () {
      ...
      g.each(function () {
        ...
        if (
          ...
          var l = Math.round(d) + c.offset
          var m = c.scrollHorizontal ? l + a.width() : l + a.height()
      ...
      b(document).bind(
        ...
        this.checkElements
      ), b(e.scrollBox).bind('load scroll', this.checkElements), b(
      window
    ).resize(function (f) {

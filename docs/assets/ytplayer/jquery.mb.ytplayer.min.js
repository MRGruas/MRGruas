  ...
  (jQuery.mbYTPlayer = {
      ...
      return this.each(function() {
        ...
        "undefined" != typeof property &&
          ...
          (property.vol =
            0 === property.vol
              ? (property.vol = 1)
              : property.vol), jQuery.extend(YTPlayer.opt, jQuery.mbYTPlayer.defaults, options, property), YTPlayer.hasChanged || ((YTPlayer.defaultOpt = {}), jQuery.extend(YTPlayer.defaultOpt, jQuery.mbYTPlayer.defaults, options)), "true" == YTPlayer.opt.loop && (YTPlayer.opt.loop = 9999), (YTPlayer.isRetina = window.retina || window.devicePixelRatio > 1);
          ...
          (YTPlayer.canPlayOnMobile =
            ...
            0 ===
              jQuery(this).children()
                .length), (YTPlayer.isPlayer = !1), isPlayer
            ? (YTPlayer.isPlayer = !0)
            : $YTPlayer.hide();
                      ...
                      events: {
                        ...
                        onError: function(a) {
                          150 == a.data &&
                            ...
                            YTPlayer.isPlayList &&
                            jQuery(YTPlayer).playNext(), "function" ==
                            typeof YTPlayer.opt.onError &&
          ...
          function(b) {
            function c(b) {
              (a.videoData = {}), (a.videoData.id =
                ...
                "auto" == a.opt.ratio ? "16/9" : a.opt.ratio), (a.opt.ratio =
    ...
    changeMovie: function(a) {
      ...
      (c.opt.startAt = 0), (c.opt.stopAt = 0), (c.opt.mask = !1), (c.opt.mute = !0), (c.hasData = !1), (c.hasChanged = !0), (c.player.loopTime = void 0), a &&
        ...
        c.opt.videoURL
      ).videoID), "true" == c.opt.loop && (c.opt.loop = 9999), jQuery(
        c.playerEl
    ...
    togglePlay: function(a) {
      var b = this.get(0);
      return 1 == b.state ? this.YTPPause() : this.YTPPlay(), "function" ==
        typeof a && a(b.state), this;
    },
    stop: function() {
      var a = this.get(0),
    ...
    checkForStart: function(a) {
      ...
      (a.start_from_last = null), a.player.playVideo(), a.player.seekTo(
        ...
        if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
          clearInterval(a.checkForStartAt), "function" ==
            typeof a.opt.onReady && a.opt.onReady(a), (a.isReady = !0);
  ...
  normalizeCss: function(a) {
    ...
    for (var c in b) {
      "transform" === c &&
        ...
        jQuery.browser.mozilla ||
        ((b[jQuery.CSS.sfx + "filter"] = a[c]), delete b[c]), "blur" === c &&
...
var getOS = function() {
  ...
  return -1 != navigator.appVersion.indexOf("Win") &&
    (a.name = "Windows"), -1 != navigator.appVersion.indexOf("Mac") &&
    0 > navigator.appVersion.indexOf("Mobile") &&
    (a.name = "Mac"), -1 != navigator.appVersion.indexOf("Linux") &&
    ...
    "Unknown"), (a.minor_version = "Unknown"), "Unknown.Unknown" != a.version &&
    (
...
-1 != (ix = jQuery.browser.fullVersion.indexOf(";")) &&
  ...
  jQuery.browser.mobile &&
  765 < jQuery(window).width()), (jQuery.isAndroidDefault =
  ...
  (a.simpleSlider = {
    ...
    init: function(b) {
      return this.each(function() {
        ...
        d.prepend(
          e
        ), (c.level = e), d.css({ cursor: "default" }), "auto" == c.opt.scale && (c.opt.scale = a(c).outerWidth()), d.updateSliderVal(), c
          .opt.readonly ||
          (
            d.on(a.simpleSlider.events.start, function(b) {
              a.browser.mobile &&
                (b =
                  b
                    .changedTouches[0]), (c.canSlide = !0), d.updateSliderVal(b), "h" == c.opt.orientation ? d.css({ cursor: "col-resize" }) : d.css({ cursor: "row-resize" }), b.preventDefault(), b.stopPropagation();
            }),
            a(document)
      ...
      if (c.opt) {
        ...
        (c.x =
          ...
          c.scaleX > c.opt.scale
            ? c.scaleX - c.opt.scale
            : 0 > c.scaleX ? c.scaleX : 0), (c.outOfRangeY =
          c.scaleY > c.opt.scale
            ? c.scaleY - c.opt.scale
            : 0 > c.scaleY ? c.scaleY : 0), (c.outOfRange =
          "h" == c.opt.orientation ? c.outOfRangeX : c.outOfRangeY), (c.value =
          "undefined" != typeof b
            ? "h" == c.opt.orientation
              ...
              : c.y >= this.outerHeight()
                ? c.opt.scale
                : 0 >= c.y ? 0 : c.scaleY
            : "h" == c.opt.orientation ? c.scaleX : c.scaleY), "h" ==
        c.opt.orientation
          ? c.level.width(Math.floor(100 * c.x / d) + "%")
          : c.level.height(Math.floor(100 * c.y / e)), "function" ==
          typeof c.opt.callback && c.opt.callback(c);
      }
    }
  ...
  (a.mbCookie = {
    set: function(a, b, c, d) {
      "object" == typeof b && (b = JSON.stringify(b)), (d = d
        ? "; domain=" + d
        : "");
      var e = new Date(),
        f = "";
    ...
    set: function(a, b) {
      "object" == typeof b && (b = JSON.stringify(b)), localStorage.setItem(
        a,
        b
      );
    },

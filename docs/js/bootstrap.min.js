    ...
    (k = (function () {
      ...
      return (t.toggle = function () {
        ...
        return this.each(function () {
          var t = m(this).data(v)
          t ||
              ((t = new n(this)), m(this).data(v, t)), e === 'toggle' && t[e]()
        })
      }), o(n, null, [
        {
          key: 'VERSION',
    ...
    (gt = (function () {
      ...
      return (t.toggle = function () {
        ...
        return this.each(function () {
          var t = tt(this)
          var e = t.data(nt)
          var n = h({}, st, t.data(), typeof i === 'object' && i)
          if (
            (
    ...
    (se = (function () {
      ...
      return (t.toggle = function (t) {
        ...
        return this.each(function () {
          ...
          var e = h({}, r.Default, Bt(this).data(), typeof n === 'object' && n)
          if (
            (
      ...
      return (t.enable = function () {
        ...
        var r = function () {
          e._hoverState !== me &&
            ...
            'aria-describedby'
          ), oe(e.element).trigger(e.constructor.Event.HIDDEN), e._popper !==
                null && e._popper.destroy(), t && t()
        }
        ...
        (e = e || oe(t.currentTarget).data(n)) ||
            ...
            ), t && (e._activeTrigger[t.type === 'focusin' ? Ae : Ie] = !0), oe(
          e.getTipElement()
        ...
        return typeof (t = h(
          ...
          t
            ...
            'number' &&
            (t.delay = { show: t.delay, hide: t.delay }), typeof t.title ===
  ...
  var kn = (
    ...
    (nn = (function () {
      ...
      return (t.refresh = function () {
        ...
        if (typeof (t = h({}, qe, t)).target !== 'string') {
  ...
  var Pn = (
    ...
    (Tn = (function () {
      ...
      return (t.show = function () {
        ...
        var i = this
        var r = (e.nodeName === 'UL' ? rn(e).find(pn) : rn(e).children(mn))[0]
        ...
        if (e) {
          ...
          i && rn(i).removeClass(cn), e.getAttribute('role') === 'tab' &&

...
+(function (a) {
  ...
  function b (b) {
    return this.each(function () {
      var c = a(this)
      var e = a.extend({}, d.DEFAULTS, c.data(), typeof b === 'object' && b)
      var f = c.data('bs.validator');
      (f || b != 'destroy') &&
        (
  ...
  var d = function (b, c) {
    ...
    a.extend(d.VALIDATORS, c.custom), this.$element.attr(
      'novalidate',
      !0
    ), this.toggleSubmit(), this.$element.on(
  ...
  (d.DEFAULTS = {
    ...
    if (
      ...
      this.runValidators(c).done(function (f) {
        c.data(
          'bs.validator.errors',
          f
        ), f.length ? e.showErrors(c) : e.clearErrors(c), (d && f.toString() === d.toString()) || ((b = f.length ? a.Event('invalid.bs.validator', { relatedTarget: c[0], detail: f }) : a.Event('valid.bs.validator', { relatedTarget: c[0], detail: d })), e.$element.trigger(b)), e.toggleSubmit(), e.$element.trigger(a.Event('validated.bs.validator', { relatedTarget: c[0] }))
      })
    }
    ...
    function c (a) {
      return (
        b.data(a + '-error') ||
        b.data('error') ||
        (a == 'native' && b[0].validationMessage) ||
        g.errors[a]
      )
    }
    var e = []
    ...
    return b.data('bs.validator.deferred') &&
      b.data('bs.validator.deferred').reject(), b.data(
    ...
    return (this.options.delay = 0), this.$element
      .find(c)
      .trigger('input.bs.validator'), (this.options.delay = a), this
    ...
    this.defer(b, function () {
      ...
      g.length &&
        (
          (g = a('<ul/>').addClass('list-unstyled').append(
            a.map(g, function (b) {
              return a('<li/>')[c](b)
            })
          )),
    ...
    c.html(c.data('bs.validator.originalContent')), b.removeClass(
      'has-error'
    ), d.length &&
    ...
    return (c = a.proxy(c, this)), this.options.delay
      ? (
    ...
    return this.$element
      ...
      .removeClass('disabled'), this.$element
      .find('.has-error')
      .removeClass('has-error'), this
  })

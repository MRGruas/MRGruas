...
!(function (t, e) {
  ...
  (d.constructor = o), (d._create = function () {
    ...
    var r =
        o.indexOf('%') != -1 ? parseFloat(o) / 100 * s.width : parseInt(o, 10)
    var a =
        n.indexOf('%') != -1 ? parseFloat(n) / 100 * s.height : parseInt(n, 10);
    ...
    var n = parseInt(t, 10)
    var s = parseInt(e, 10)
    var r = n === this.position.x && s === this.position.y
  ...
  (d.enableTransition = function () {
    if (!this.isTransitioning) {
      ...
      (t = typeof t === 'number' ? t + 'ms' : t), this.css({
  ...
  return (o._resetLayout = function () {
    ...
    for (var t = 0, e = this.cols; --e && this.colYs[e] === 0;) {
      t++
    }
  ...
  var i = t.create('masonry')
  var o = i.prototype
  var n = { _getElementOffset: !0, layout: !0, _getMeasurement: !0 }

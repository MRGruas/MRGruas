...
!(function (a, b) {
  ...
  var s = (function (a) {
    ...
    var Q =
        ...
        P +
        ')*)|.*)\\)|)'
    var R = new RegExp('^' + M + '+|((?:^|[^\\\\])(?:\\\\.)*)' + M + '+$', 'g')
    var S = new RegExp('^' + M + '*,' + M + '*')
    var T = new RegExp('^' + M + '*([>+~]|' + M + ')' + M + '*')
    var U = new RegExp('=' + M + "*([^\\]'\"]*?)" + M + '*\\]', 'g')
    var V = new RegExp(Q)
    var W = new RegExp('^' + O + '$')
    var X = {
      ID: new RegExp('^#(' + N + ')'),
    ...
    var ab = /[+~]/
    var bb = /'|\\/g
    var cb = new RegExp('\\\\([\\da-f]{1,6}' + M + '?|(' + M + ')|.)', 'ig')
    ...
    (c = fb.support = {}), (f = fb.isXML = function (a) {
      ...
      return e !== n && e.nodeType === 9 && e.documentElement
        ? (
          ...
          (c.getElementsByClassName =
              ...
              ib(function (a) {
                return (a.innerHTML =
                  "<div class='a'></div><div class='a i'></div>"), (a.firstChild.className = 'i'), a.getElementsByClassName('i').length === 2
              })),
      ...
      var f = e && E.call(d.attrHandle, b.toLowerCase()) ? e(a, b, !p) : void 0
      return void 0 !== f
        ? f
        : c.attributes || !p
          ? a.getAttribute(b)
    ...
    function vb (a, b, c, d, e, f) {
      return d && !d[u] && (d = vb(d)), e &&
        ...
        var n = []
        var o = g.length
        var p = f || tb(b || '*', h.nodeType ? [h] : h, [])
        var q = !a || (!f && b) ? p : ub(p, m, a, h, i)
  ...
  (m.filter = function (a, b, c) {
    ...
    is: function (a) {
      return !!w(this, typeof a === 'string' && t.test(a) ? m(a) : a || [], !1)
        .length
    },
  })
  var x
  ...
  (m.event = {
        ...
        (
          ...
          d.nodeType !== 3 &&
            ...
            (
              ...
              (b = b[m.expando]
                ? b
                : new m.Event(p, typeof b === 'object' && b)),
              (b.isTrigger = e ? 2 : 3),
              (b.namespace = q.join('.')),
    ...
    fix: function (a) {
      ...
      return a.target || (a.target = f.srcElement || y), a.target.nodeType ===
        3 &&
  ...
  var nb = /checked\s*(?:[^=]|=\s*.checked.)/i
  var ob = /^$|\/(?:java|ecma)script/i
  var pb = /^true\/(.*)/
  var qb = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
  var rb = {
  ...
  var sb = db(y)
  var tb = sb.appendChild(y.createElement('div'));
  (rb.optgroup =
  ...
  m.extend({
    ...
    remove: function (a, b) {
      for (
        ...
        b || c.nodeType !== 1 || m.cleanData(ub(c)), c.parentNode &&
          (
    ...
    : y.documentElement.currentStyle &&
      (
        ...
        (Jb = function (a, b, c) {
          ...
          var g
          var h = a.style
          return (c = c || Ib(a)), (g = c ? c[b] : void 0), g == null &&
            h &&
            h[b] &&
            (g = h[b]), Hb.test(g) &&
            !Kb.test(b) &&
  ...
  var Pb = new RegExp('^(' + S + ')(.*)$', 'i')
  var Qb = new RegExp('^([+-])=(' + S + ')', 'i')
  var Rb = { position: 'absolute', visibility: 'hidden', display: 'block' }
  var Sb = { letterSpacing: '0', fontWeight: '400' }
  var Tb = ['Webkit', 'O', 'Moz', 'ms']
  function Ub (a, b) {
    if (b in a) {
      return b
    }
  ...
  m.extend({
    ...
    css: function (a, b, c, d) {
      ...
      return (b = m.cssProps[h] || (m.cssProps[h] = Ub(a.style, h))), (g =
        ...
        'get' in g &&
        (f = g.get(a, !0, c)), void 0 === f && (f = Jb(a, b, d)), f ===
        'normal' &&
        b in Sb &&
        (f = Sb[b]), c === '' || c
  ...
  var $b
  var _b
  var ac = /^(?:toggle|show|hide)$/
  var bc = new RegExp('^(?:([+-])=|)(' + S + ')([a-z%]*)$', 'i')
  var cc = /queueHooks$/
  var dc = [ic]
  var ec = {
    '*': [
  ...
  var mc
  var nc
  var oc = m.expr.attrHandle
  var pc = /^(?:checked|selected)$/i
  var qc = k.getSetAttribute
  var rc = k.input
  m.fn.extend({
    attr: function (a, b) {
      ...
      (mc = {
        set: function (a, b, c) {
          ...
          return d ||
            ...
            ), (d.value = b += ''), c === 'value' || b === a.getAttribute(c)
            ? b
            : void 0
        },
      }),
  ...
  var Bc = /([?&])_=[^&]*/
  var Cc = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm
  var Dc = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/
  var Ec = /^(?:GET|HEAD)$/
  var Fc = /^\/\//
  var Gc = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/
  var Hc = {}
  ...
  var Rc = /\[\]$/
  var Sc = /\r?\n/g
  var Tc = /^(?:submit|button|image|reset|file)$/i
            ...
            f.send((a.hasContent && a.data) || null), (b = function (c, e) {
              ...
              if (b && (e || f.readyState === 4)) {
                if (
                  ...
                  (j = {}), (h = f.status), typeof f.responseText === 'string' &&
  ...
  (m.offset = {
    setOffset: function (a, b, c) {
      ...
      k === 'static' &&
        ...
        (n.top = b.top - h.top + g), b.left != null &&

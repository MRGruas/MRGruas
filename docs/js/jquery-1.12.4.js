...
!(function (e, t) {
  ...
  (p.fn = p.prototype = {
    ...
    for (
      typeof a === 'boolean' &&
        ((u = a), (a = arguments[s] || {}), s++), typeof a === 'object' ||
        p.isFunction(a) ||
        (a = {}), s === l && ((a = this), s--);
      s < l;
      s++
  ...
  var x = (function (e) {
    ...
    var B =
        ...
        P +
        ')*)|.*)\\)|)'
    var W = new RegExp(O + '+', 'g')
    var I = new RegExp('^' + O + '+|((?:^|[^\\\\])(?:\\\\.)*)' + O + '+$', 'g')
    var $ = new RegExp('^' + O + '*,' + O + '*')
    var z = new RegExp('^' + O + '*([>+~]|' + O + ')' + O + '*')
    var X = new RegExp('=' + O + "*([^\\]'\"]*?)" + O + '*\\]', 'g')
    var U = new RegExp(B)
    var V = new RegExp('^' + R + '$')
    var Y = {
      ID: new RegExp('^#(' + R + ')'),
    ...
    var Z = /[+~]/
    var ee = /'|\\/g
    var te = new RegExp('\\\\([\\da-f]{1,6}' + O + '?|(' + O + ')|.)', 'ig')
    ...
    function ie (e, t, r, i) {
      ...
      var v
      var y
      var T = t && t.ownerDocument
      var C = t ? t.nodeType : 9
      if (
        (
          (r = r || []),
    ...
    (n = ie.support = {}), (o = ie.isXML = function (e) {
      ...
      var o = i && D.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !g) : void 0
      return void 0 !== o
        ? o
        : n.attributes || !g
          ? e.getAttribute(t)
      ...
      preFilter: {
        ...
        CHILD: function (e) {
          return (e[1] = e[1].toLowerCase()), e[1].slice(0, 3) === 'nth'
            ? (
              e[3] || ie.error(e[0]),
              (e[4] = +(e[4]
                ? e[5] + (e[6] || 1)
              ...
              if (m) {
                if (o) {
                  for (; g;) {
                    for (d = t; (d = d[g]);) {
                      if (
                        s ? d.nodeName.toLowerCase() === v : d.nodeType === 1
                      ) {
                        return !1
                      }
                    }
    ...
    function ye (e, t, n, r, i) {
      for (var o, a = [], s = 0, l = e.length, u = t != null; s < l; s++) {
    ...
    function xe (e, t, n, r, i, o) {
      return r && !r[b] && (r = xe(r)), i &&
        ...
        if (o) {
          ...
          (v = ye(v === a ? v.splice(h, v.length) : v)), i ? i(null, a, v, l) : q.apply(a, v)
        }
      })
    }
    function be (e) {
  ...
  var T = p.expr.match.needsContext
  var C = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/
  var E = /^.[^:#\[\.,]*$/
  function N (e, t, n) {
    if (p.isFunction(t)) {
  ...
  (p.filter = function (e, t, n) {
    var r = t[0]
    return n && (e = ':not(' + e + ')'), t.length === 1 && r.nodeType === 1
    ...
    is: function (e) {
      return !!N(this, typeof e === 'string' && T.test(e) ? p(e) : e || [], !1)
        .length
    },
  })
  var k
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = T.test(e) || typeof e !== 'string' ? p(e, t || this.context) : 0;
        r < i;
        r++
      ) {
        for (n = this[r]; n && n !== t; n = n.parentNode) {
          if (
            ...
            (a
              ? a.index(n) > -1
              : n.nodeType === 1 && p.find.matchesSelector(n, e))
          ) {
            o.push(n)
            break
          }
  ...
  (p.Callbacks = function (e) {
              ...
              (function t (n) {
                p.each(n, function (n, r) {
                  p.isFunction(r)
                    ...
                    : r && r.length && p.type(r) !== 'string' && t(r)
                })
              })(arguments),
              i && !r && c()
            ), this
    ...
    when: function (e) {
      ...
      var s = a.length
      var l = s !== 1 || (e && p.isFunction(e.promise)) ? s : 0
      var u = l === 1 ? e : p.Deferred()
  ...
  (f.ownFirst = H === '0'), (f.inlineBlockNeedsLayout = !1), p(function () {
    var e, t, n, i;
  ...
  function W (e) {
    var t
    for (t in e) {
      if ((t !== 'data' || !p.isEmptyObject(e[t])) && t !== 'toJSON') {
        return !1
      }
    }
    return !0
    ...
    if (O(e)) {
      ...
      if (
        ...
        return c || (c = l ? (e[s] = n.pop() || p.guid++) : s), u[c] ||
          (u[c] = l ? {} : { toJSON: p.noop }), (typeof t !== 'object' &&
          typeof t !== 'function') ||
          (i
            ? (u[c] = p.extend(u[c], t))
            : (u[c].data = p.extend(u[c].data, t))), (a = u[c]), i ||
          (a.data || (a.data = {}), (a = a.data)), void 0 !== r &&
          (a[p.camelCase(t)] = r), typeof t === 'string'
          ? (o = a[t]) == null && (o = a[p.camelCase(t)])
          : (o = a), o
      }
    }
  }
  ...
  p.extend({
    ...
    data: function (e, t) {
      ...
      if (void 0 === e) {
        if (
          this.length &&
          ((i = p.data(o)), o.nodeType === 1 && !p._data(o, 'parsedAttrs'))
        ) {
          for (n = a.length; n--;) {
            a[n] &&
  ...
  var V = function (e, t) {
    return (e = t || e), p.css(e, 'display') === 'none' ||
  ...
  function Y (e, t, n, r) {
    ...
    var l = s()
    var u = (n && n[3]) || (p.cssNumber[t] ? '' : 'px')
    var c = (p.cssNumber[t] || (u !== 'px' && +l)) && X.exec(p.css(e, t))
    if (c && c[3] !== u) {
      (u = u || c[3]), (n = n || []), (c = +l || 1)
      do {
  ...
  (p.event = {
    ...
    trigger: function (t, n, i, o) {
      ...
      var h
      var g = [i || r]
      var m = c.call(t, 'type') ? t.type : t
      var v = c.call(t, 'namespace') ? t.namespace.split('.') : []
      if (
        (
          (l = d = i = i || r),
          i.nodeType !== 3 &&
            ...
            (
              ...
              ((t = t[p.expando]
                ? t
                : new p.Event(m, typeof t === 'object' && t)).isTrigger = o
                ? 2
                : 3),
              (t.namespace = v.join('.')),
    ...
    dispatch: function (e) {
      ...
      var u = (p._data(this, 'events') || {})[e.type] || []
      var c = p.event.special[e.type] || {}
      if (
        (
          (l[0] = e),
    ...
    fix: function (e) {
      ...
      return e.target || (e.target = a.srcElement || r), e.target.nodeType ===
        3 &&
    ...
    keyHooks: {
      ...
      filter: function (e, t) {
        return e.which == null &&
          (e.which = t.charCode != null ? t.charCode : t.keyCode), e
      },
    },
    mouseHooks: {
  ...
  function _e (e, t, n, r) {
    ...
    var g = h - 1
    var m = t[0]
    var v = p.isFunction(m)
    if (v || (h > 1 && typeof m === 'string' && !f.checkClone && Ne.test(m))) {
  ...
  function Fe (e, t, n) {
    for (var r, i = t ? p.filter(t, e) : e, o = 0; (r = i[o]) != null; o++) {
      n || r.nodeType !== 1 || p.cleanData(ae(r)), r.parentNode &&
        (
  ...
  p.extend({
    ...
    clone: function (e, t, n) {
      ...
      var a
      var s
      var l = p.contains(e.ownerDocument, e)
      if (
        (
        ...
        for (r = ae(o), s = ae(e), a = 0; (i = s[a]) != null; ++a) {
          r[a] && qe(i, r[a])
        }
      }
      if (t) {
        if (n) {
          for (s = s || ae(e), r = r || ae(o), a = 0; (i = s[a]) != null; a++) {
            He(i, r[a])
          }
        } else {
          He(e, o)
    ...
    empty: function () {
      for (var e, t = 0; (e = this[t]) != null; t++) {
        for (e.nodeType === 1 && p.cleanData(ae(e, !1)); e.firstChild;) {
    ...
    html: function (e) {
      return K(
        ...
        function (e) {
          ...
          var r = this.length
          if (void 0 === e) {
            return t.nodeType === 1 ? t.innerHTML.replace(we, '') : void 0
          }
          if (
            typeof e === 'string' &&
            !Ee.test(e) &&
  ...
  var Me
  var Oe = { HTML: 'block', BODY: 'block' }
  function Re (e, t) {
    var n = p(t.createElement(e)).appendTo(t.body)
    var r = p.css(n[0], 'display')
    return n.detach(), r
  }
  function Pe (e) {
    var t = r
  ...
  !(function () {
    ...
    function c () {
      ...
      d.appendChild(
        l
      ), (u.style.cssText = '-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%'), (t = i = s = !1), (n = a = !0), e.getComputedStyle && ((f = e.getComputedStyle(u)), (t = (f || {}).top !== '1%'), (s = (f || {}).marginLeft === '2px'), (i = (f || { width: '4px' }).width === '4px'), (u.style.marginRight = '50%'), (n = (f || { marginRight: '4px' }).marginRight === '4px'), ((c = u.appendChild(r.createElement('div'))).style.cssText = u.style.cssText = '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0'), (c.style.marginRight = c.style.width = '0'), (u.style.width = '1px'), (a = !parseFloat((e.getComputedStyle(c) || {}).marginRight)), u.removeChild(c)), (u.style.display = 'none'), (o = u.getClientRects().length === 0) && ((u.style.display = ''), (u.innerHTML = '<table><tr><td></td><td>t</td></tr></table>'), (u.childNodes[0].style.borderCollapse = 'separate'), ((c = u.getElementsByTagName('td'))[0].style.cssText = 'margin:0;border:0;padding:0;display:none'), (o = c[0].offsetHeight === 0) && ((c[0].style.display = ''), (c[1].style.display = 'none'), (o = c[0].offsetHeight === 0))), d.removeChild(l)
    }
    u.style &&
      (
        (u.style.cssText = 'float:left;opacity:.5'),
        (f.opacity = u.style.opacity === '0.5'),
  ...
  e.getComputedStyle
    ? (
      ...
      (Xe = function (e, t, n) {
        ...
        var a
        var s = e.style
        return ((a = (n = n || ze(e)) ? n.getPropertyValue(t) || n[t] : void 0) !==
            '' &&
            void 0 !== a) ||
            p.contains(e.ownerDocument, e) ||
            (a = p.style(e, t)), n &&
    ...
    : $e.currentStyle &&
      (
        ...
        (Xe = function (e, t, n) {
          ...
          var a
          var s = e.style
          return (a = (n = n || ze(e)) ? n[t] : void 0) == null &&
            s &&
            s[t] &&
            (a = s[t]), We.test(a) &&
            !Ue.test(t) &&
  ...
  var Ye = /alpha\([^)]*\)/i
  var Je = /opacity\s*=\s*([^)]*)/i
  var Ge = /^(none|table(?!-c[ea]).+)/
  var Qe = new RegExp('^(' + z + ')(.*)$', 'i')
  var Ke = { position: 'absolute', visibility: 'hidden', display: 'block' }
  var Ze = { letterSpacing: '0', fontWeight: '400' }
  var et = ['Webkit', 'O', 'Moz', 'ms']
  var tt = r.createElement('div').style
  function nt (e) {
    if (e in tt) {
      return e
    }
  ...
  function ot (e, t, n, r, i) {
    for (
      ...
      n === 'margin' && (a += p.css(e, n + U[o], !0, i)), r
        ? (
          n === 'content' && (a -= p.css(e, 'padding' + U[o], !0, i)),
          n !== 'margin' && (a -= p.css(e, 'border' + U[o] + 'Width', !0, i))
        )
        : (
          (a += p.css(e, 'padding' + U[o], !0, i)),
          n !== 'padding' && (a += p.css(e, 'border' + U[o] + 'Width', !0, i))
        )
    }
    return a
  }
  function at (e, t, n) {
    ...
    var o = ze(e)
    var a = f.boxSizing && p.css(e, 'boxSizing', !1, o) === 'border-box'
    if (i <= 0 || i == null) {
      if (
        (((i = Xe(e, t, o)) < 0 || i == null) && (i = e.style[t]), We.test(i))
      ) {
        return i
      }
  ...
  p.extend({
    ...
    css: function (e, t, n, r) {
      ...
      return (t = p.cssProps[s] || (p.cssProps[s] = nt(s) || s)), (a =
        ...
        'get' in a &&
        (o = a.get(e, !0, n)), void 0 === o && (o = Xe(e, t, r)), o ===
        'normal' &&
        t in Ze &&
        (o = Ze[t]), n === '' || n
    ...
    p.cssHooks[t] = {
      get: function (e, n, r) {
        if (n) {
          return Ge.test(p.css(e, 'display')) && e.offsetWidth === 0
            ? Ie(e, Ke, function () {
              return at(e, t, r)
            })
            : at(e, t, r)
        ...
        return it(
          ...
          r
            ? ot(
              ...
              t,
              r,
              f.boxSizing && p.css(e, 'boxSizing', !1, i) === 'border-box',
              i
            )
            : 0
        )
    ...
    (p.cssHooks.opacity = {
      ...
      set: function (e, t) {
        ...
        var i = p.isNumeric(t) ? 'alpha(opacity=' + 100 * t + ')' : ''
    ...
    if (t) {
      return Ie(e, { display: 'inline-block' }, Xe, [e, 'marginRight'])
    }
    ...
    _default: {
      get: function (e) {
        ...
        (e.elem[e.prop] != null && e.elem.style[e.prop] == null)
          ? e.elem[e.prop]
          : (t = p.css(e.elem, e.prop, '')) && t !== 'auto' ? t : 0
      },
      set: function (e) {
        p.fx.step[e.prop]
          ? p.fx.step[e.prop](e)
  ...
  function bt (e, t, n) {
    ...
    var i
    var o = 0
    var a = bt.prefilters.length
    var s = p.Deferred().always(function () {
      delete l.elem
    })
    var l = function () {
      if (i) {
  ...
  (p.Animation = p.extend(bt, {
    ...
    prefilters: [
      function (e, t, n) {
        ...
        var d = {}
        var h = e.style
        var g = e.nodeType && V(e)
        var m = p._data(e, 'fxshow')
        n.queue ||
          (
            (s = p._queueHooks(e, 'fx')).unqueued == null &&
              (
                (s.unqueued = 0),
                (l = s.empty.fire),
          ...
          (
            ...
            ((u = p.css(e, 'display')) === 'none'
              ? p._data(e, 'olddisplay') || Pe(e.nodeName)
              : u) ===
              'inline' &&
              p.css(e, 'float') === 'none' &&
              (f.inlineBlockNeedsLayout && Pe(e.nodeName) !== 'inline'
                ? (h.zoom = 1)
        ...
        if (p.isEmptyObject(d)) {
          (u === 'none' ? Pe(e.nodeName) : u) === 'inline' && (h.display = u)
        } else {
          m
    ...
    return (r.duration = p.fx.off
      ...
      : typeof r.duration === 'number'
        ...
        : r.duration in p.fx.speeds
          ...
          : p.fx.speeds._default), (r.queue != null && !0 !== r.queue) ||
    ...
    stop: function (e, t, n) {
      ...
      return typeof e !== 'string' && ((n = t), (t = e), (e = void 0)), t &&
        !1 !== e &&
    ...
    'input'
  )), (dt = r.createElement('div')), (pt = r.createElement('select')), (ht = pt.appendChild(r.createElement('option'))), (dt = r.createElement('div')).setAttribute('className', 't'), (dt.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"), (ct = dt.getElementsByTagName('a')[0]), ft.setAttribute('type', 'checkbox'), dt.appendChild(ft), ((ct = dt.getElementsByTagName('a')[0]).style.cssText = 'top:1px'), (f.getSetAttribute = dt.className !== 't'), (f.style = /top/.test(ct.getAttribute('style'))), (f.hrefNormalized = ct.getAttribute('href') === '/a'), (f.checkOn = !!ft.value), (f.optSelected = ht.selected), (f.enctype = !!r.createElement('form').enctype), (pt.disabled = !0), (f.optDisabled = !ht.disabled), (ft = r.createElement('input')).setAttribute('value', ''), (f.input = ft.getAttribute('value') === ''), (ft.value = 't'), ft.setAttribute('type', 'radio'), (f.radioValue = ft.value === 't')
  var wt = /\r/g
  var Tt = /[\x20\t\r\n\f]+/g
  p.fn.extend({
    val: function (e) {
      ...
      return arguments.length
        ? (
          ...
          this.each(function (n) {
            ...
            this.nodeType === 1 &&
                (
                  (i = r ? e.call(this, n, p(this).val()) : e) == null
                    ? (i = '')
                    : typeof i === 'number'
                      ? (i += '')
                      : p.isArray(i) &&
    ...
    valHooks: {
      option: {
        get: function (e) {
          ...
          return t != null ? t : p.trim(p.text(e)).replace(Tt, ' ')
        },
      },
      select: {
        get: function (e) {
  ...
  var Ct
  var Et
  var Nt = p.expr.attrHandle
  var kt = /^(?:checked|selected)$/i
  var St = f.getSetAttribute
  var At = f.input
  p.fn.extend({
    attr: function (e, t) {
          ...
          : (
            ...
            void 0 !== n
              ...
              : i && 'get' in i && (r = i.get(e, t)) !== null
                ? r
                : (r = p.find.attr(e, t)) == null ? void 0 : r
          )
      }
    },
    attrHooks: {
      type: {
        set: function (e, t) {
          if (!f.radioValue && t === 'radio' && p.nodeName(e, 'input')) {
            var n = e.value
  ...
  var Xt = '*/'.concat('*')
  var Ut = qt.href
  var Vt = It.exec(Ut.toLowerCase()) || []
  function Yt (e) {
    return function (t, n) {
      typeof t !== 'string' && ((n = t), (t = '*'))
      var r
      var i = 0
      var o = t.toLowerCase().match(q) || []
      if (p.isFunction(n)) {
        for (; (r = o[i++]);) {
          r.charAt(0) === '+'
  ...
  function Gt (e, t) {
    var n
    var r
    var i = p.ajaxSettings.flatOptions || {}
    for (r in t) {
  ...
  p.extend({
    ...
    ajax: function (t, n) {
      ...
      var f = p.ajaxSetup({}, n)
      var d = f.context || f
      var h = f.context && (d.nodeType || d.jquery) ? p(d) : p.event
      var g = p.Deferred()
      var m = p.Callbacks('once memory')
      var v = f.statusCode || {}
      var y = {}
      var x = {}
      var b = 0
      ...
      if (f.beforeSend && (!1 === f.beforeSend.call(d, T, f) || b === 2)) {
        return T.abort()
      }
      w = 'abort'
      ...
      if ((u = Jt(zt, f, n, T))) {
        if (((T.readyState = 1), l && h.trigger('ajaxSend', [T, f]), b === 2)) {
          return T
        }
        f.async &&
          f.timeout > 0 &&
    ...
    return f.reliableHiddenOffsets()
      ...
      : (function (e) {
        if (!p.contains(e.ownerDocument || r, e)) {
          return !0
        }
        for (; e && e.nodeType === 1;) {
          if (
  ...
  var Kt = /\[\]$/
  var Zt = /\r?\n/g
  var en = /^(?:submit|button|image|reset|file)$/i
  var tn = /^(?:input|select|textarea|keygen)/i
  function nn (e, t, n, r) {
    var i
    if (p.isArray(t)) {
  ...
  (p.param = function (e, t) {
    ...
    var r = []
    var i = function (e, t) {
      (t = p.isFunction(t) ? t() : t == null ? '' : t), (r[r.length] =
  ...
  e.attachEvent &&
            ...
            a.send((t.hasContent && t.data) || null), (n = function (e, r) {
              ...
              if (n && (r || a.readyState === 4)) {
                if (
                  ...
                  (u = {}), (o = a.status), typeof a.responseText === 'string' &&
    ...
    if (e.crossDomain) {
      var t
      var n = r.head || p('head')[0] || r.documentElement
      return {
        send: function (i, o) {
  ...
  (p.fn.load = function (e, t, n) {
    ...
    return s > -1 &&
      ...
      ? ((n = t), (t = void 0))
      : t && typeof t === 'object' && (i = 'POST'), a.length > 0 &&
      p
    ...
    setOffset: function (e, t, n) {
      ...
      u === 'static' &&
        ...
        e,
        'top'
      )), (l = p.css(e, 'left')), (u === 'absolute' || u === 'fixed') &&
      p.inArray('auto', [o, l]) > -1
        ? ((a = (r = c.position()).top), (i = r.left))
        : ((a = parseFloat(o) || 0), (i = parseFloat(l) || 0)), p.isFunction(
        t
      ) && (t = t.call(e, n, p.extend({}, s))), t.top != null &&
        (f.top = t.top - s.top + a), t.left != null &&
    ...
    offsetParent: function () {
      return this.map(function () {
        for (
          ...
          e && !p.nodeName(e, 'html') && p.css(e, 'position') === 'static';
    ...
    return this.length
  }), (p.fn.andSelf = p.fn.addBack), typeof define === 'function' &&
    define.amd &&
...
(function (e) {
  ...
  function t (t, s) {
    ...
    return r === 'area'
      ? (
        (n = t.parentNode),
        (a = n.name),
        t.href && a && n.nodeName.toLowerCase() === 'map'
  ...
  function s (e) {
    for (var t, i; e.length && e[0] !== document;) {
      if (
        (
          (t = e.css('position')),
          (t === 'absolute' || t === 'relative' || t === 'fixed') &&
            ((i = parseInt(e.css('zIndex'), 10)), !isNaN(i) && i !== 0)
        )
      ) {
        return i
      }
  ...
  function a (t) {
    ...
    return t
      .delegate(i, 'mouseout', function () {
        e(this).removeClass(
          'ui-state-hover'
        ), this.className.indexOf('ui-datepicker-prev') !== -1 && e(this).removeClass('ui-datepicker-prev-hover'), this.className.indexOf('ui-datepicker-next') !== -1 && e(this).removeClass('ui-datepicker-next-hover')
      })
  ...
  (e.ui =
    ...
    {}), e.extend(e.ui, { version: '1.11.4', keyCode: { BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38 } }), e.fn.extend(
    {
      scrollParent: function (t) {
        ...
        var s = i === 'absolute'
        var n = t ? /(auto|scroll|hidden)/ : /(auto|scroll)/
        var a = this.parents()
          .filter(function () {
            var t = e(this)
            return s && t.css('position') === 'static'
              ? !1
              : n.test(
                t.css('overflow') +
                      t.css('overflow-y') +
        ...
        if (this.length) {
          for (var i, s, n = e(this[0]); n.length && n[0] !== document;) {
            if (
              (
                (i = n.css('position')),
                (i === 'absolute' || i === 'relative' || i === 'fixed') &&
                  ((s = parseInt(n.css('zIndex'), 10)), !isNaN(s) && s !== 0)
              )
            ) {
              return s
            }
  ...
  (e.cleanData = (function (t) {
    ...
    _on: function (t, i, s) {
      var n
      var a = this
      typeof t !== 'boolean' && ((s = i), (i = t), (t = !1)), s
        ...
        function r () {
          ...
          (a.options.disabled !== !0 && !e(this).hasClass('ui-state-disabled'))
            ? (typeof o === 'string' ? a[o] : o).apply(a, arguments)
            : void 0
        }
        typeof o !== 'string' &&
          (r.guid = o.guid = o.guid || r.guid || e.guid++)
        var h = s.match(/^([\w:-]*)\s*(.*)$/)
        var l = h[1] + a.eventNamespace
        var u = h[2]
    ...
    _delay: function (e, t) {
      function i () {
        return (typeof e === 'string' ? s[e] : e).apply(s, arguments)
      }
      var s = this
    ...
    e.Widget.prototype['_' + t] = function (s, n, a) {
      ...
      var o
      var r = n ? (n === !0 || typeof n === 'number' ? i : n.effect || i) : t;
      (n = n || {}), typeof n === 'number' &&
  ...
  e(document).mouseup(function () {
    ...
    (e.position = {
      ...
      getScrollInfo: function (t) {
        ...
        var s = t.isWindow || t.isDocument ? '' : t.element.css('overflow-y')
        var n =
            i === 'scroll' ||
            (i === 'auto' && t.width < t.element[0].scrollWidth)
        var a =
            s === 'scroll' ||
            (s === 'auto' && t.height < t.element[0].scrollHeight)
        return {
      ...
      getWithinInfo: function (t) {
        var i = e(t || window)
        var s = e.isWindow(i[0])
        var n = !!i[0] && i[0].nodeType === 9
        return {
          element: i,
          isWindow: s,
          isDocument: n,
      ...
      var b
      var _ = e(n.of)
      var x = e.position.getWithinInfo(n.within)
      var k = e.position.getScrollInfo(x)
      var w = (n.collision || 'flip').split(' ')
      var T = {}
      return (b = s(_)), _[0].preventDefault && (n.at = 'left top'), (m =
      ...
      }), w.length === 1 && (w[1] = w[0]), n.at[0] === 'right'
        ? (y.left += m)
        : n.at[0] === 'center' && (y.left += m / 2), n.at[1] === 'bottom'
        ? (y.top += g)
        : n.at[1] === 'center' && (y.top += g / 2), (p = t(
        T.at,
        m,
        g
        ...
        var d = u.outerWidth()
        var c = u.outerHeight()
        var f = i(this, 'marginLeft')
        var b = i(this, 'marginTop')
        var D = d + f + i(this, 'marginRight') + k.width
        var S = c + b + i(this, 'marginBottom') + k.height
        var M = e.extend({}, y)
        var N = t(T.my, u.outerWidth(), u.outerHeight())
        n.my[0] === 'right'
          ? (M.left -= d)
          : n.my[0] === 'center' &&
            (M.left -=
              d /
              2), n.my[1] === 'bottom' ? (M.top -= c) : n.my[1] === 'center' && (M.top -= c / 2), (M.left += N[0]), (M.top += N[1]), a || ((M.left = h(M.left)), (M.top = h(M.top))), (s = { marginLeft: f, marginTop: b }), e.each(
          ['left', 'top'],
          function (t, i) {
            e.ui.position[w[t]] &&
      ...
      fit: {
        left: function (e, t) {
          ...
          var a = s.width
          var r = e.left - t.collisionPosition.marginLeft
          var h = n - r
          var l = r + t.collisionWidth - a - n
          t.collisionWidth > a
            ? h > 0 && l <= 0
              ? ((i = e.left + h + t.collisionWidth - a - n), (e.left += h - i))
              : (e.left =
                  l > 0 && h <= 0 ? n : h > l ? n + a - t.collisionWidth : n)
            : h > 0
              ? (e.left += h)
        ...
        top: function (e, t) {
          ...
          var a = t.within.height
          var r = e.top - t.collisionPosition.marginTop
          var h = n - r
          var l = r + t.collisionHeight - a - n
          t.collisionHeight > a
            ? h > 0 && l <= 0
              ? ((i = e.top + h + t.collisionHeight - a - n), (e.top += h - i))
              : (e.top =
                  l > 0 && h <= 0 ? n : h > l ? n + a - t.collisionHeight : n)
            : h > 0
              ? (e.top += h)
      ...
      flip: {
        left: function (e, t) {
          ...
          var l = e.left - t.collisionPosition.marginLeft
          var u = l - h
          var d = l + t.collisionWidth - o - h
          var c =
              t.my[0] === 'left'
                ? -t.elemWidth
                : t.my[0] === 'right' ? t.elemWidth : 0
          var p =
              t.at[0] === 'left'
                ? t.targetWidth
                : t.at[0] === 'right' ? -t.targetWidth : 0
          var f = -2 * t.offset[0]
          u < 0
            ? (
              (i = e.left + c + p + f + t.collisionWidth - o - a),
              (i < 0 || r(u) > i) && (e.left += c + p + f)
            )
            : d > 0 &&
              (
        ...
        top: function (e, t) {
          ...
          var l = e.top - t.collisionPosition.marginTop
          var u = l - h
          var d = l + t.collisionHeight - o - h
          var c = t.my[1] === 'top'
          var p = c ? -t.elemHeight : t.my[1] === 'bottom' ? t.elemHeight : 0
          var f =
              t.at[1] === 'top'
                ? t.targetHeight
                : t.at[1] === 'bottom' ? -t.targetHeight : 0
          var m = -2 * t.offset[1]
          u < 0
            ? (
              (s = e.top + p + f + m + t.collisionHeight - o - a),
              (s < 0 || r(u) > s) && (e.top += p + f + m)
            )
            : d > 0 &&
              (
      ...
      t.appendChild(
        h
      ), (i = r || document.documentElement), i.insertBefore(t, i.firstChild), (h.style.cssText = 'position: absolute; left: 10.7432222px;'), (n = e(h).offset().left), (a = n > 10 && n < 11), (t.innerHTML = ''), i.removeChild(t)
    })()
    ...
    _create: function () {
      this.options.helper === 'original' && this._setPositionRelative(), this
    ...
    _blurActiveElement: function (t) {
      ...
      if (this.handleElement.is(t.target)) {
        try {
          i.activeElement &&
            i.activeElement.nodeName.toLowerCase() !== 'body' &&
    ...
    _mouseStop: function (t) {
      ...
      return e.ui.ddmanager &&
        ...
        ((s = this.dropped), (this.dropped = !1)), (this.options.revert ===
        'invalid' &&
        !s) ||
    ...
    _adjustOffsetFromHelper: function (t) {
      typeof t === 'string' && (t = t.split(' ')), e.isArray(t) &&
    ...
    _getParentOffset: function () {
      ...
      var i = this.document[0]
      return this.cssPosition === 'absolute' &&
    ...
    _convertPositionTo: function (e, t) {
      ...
      var s = this._isRootNode(this.scrollParent[0])
      return {
        top:
          t.top +
    ...
    _generatePosition: function (e, t) {
      ...
      var a
      var o = this.options
      var r = this._isRootNode(this.scrollParent[0])
      var h = e.pageX
      var l = e.pageY
      return (r && this.offset.scroll) ||
        ...
        (
          ...
          o.axis === 'y' && (h = this.originalPageX),
          o.axis === 'x' && (l = this.originalPageY)
        ), {
        top:
          l -
          this.offset.click.top -
    ...
    drag: function (t, i, s) {
      var n = s.options
      var a = !1
      var o = s.scrollParentNotHidden[0]
      var r = s.document[0]
      o !== r && o.tagName !== 'HTML'
        ? (
          (n.axis && n.axis === 'x') ||
    ...
    drag: function (t, i, s) {
      ...
      var y = i.offset.top
      var b = y + s.helperProportions.height
    ...
    start: function (t, i, s) {
      var n
      var a = s.options
      var o = e.makeArray(e(a.stack)).sort(function (t, i) {
        return (
    ...
    return function (t, i, s, n) {
      ...
      var o = (t.positionAbs || t.position.absolute).top + t.margins.top
      var r = a + t.helperProportions.width
      var h = o + t.helperProportions.height
      var l = i.offset.left
      var u = i.offset.top
      var d = l + i.proportions().width
      var c = u + i.proportions().height
      switch (s) {
        case 'fit':
    ...
    prepareOffsets: function (t, i) {
      ...
      var o = i ? i.type : null
      var r = (t.currentItem || t.element).find(':data(ui-droppable)').addBack()
      e: for (s = 0; a.length > s; s++) {
        if (
          ...
          (a[s].visible = a[s].element.css('display') !== 'none'), a[s]
            .visible &&
            (
      ...
      t.options.refreshPositions &&
        ...
        function () {
          if (!this.options.disabled && !this.greedyChild && this.visible) {
            ...
            var n
            var a
            var o = e.ui.intersect(t, this, this.options.tolerance, i)
            var r =
                !o && this.isover
                  ? 'isout'
    ...
    _mouseStart: function (t) {
      ...
      return (this.resizing = !0), this._renderProxy(), (i = this._num(
        ...
        'cursor',
        n === 'auto' ? this.axis + '-resize' : n
      ), o.addClass('ui-resizable-resizing'), this._propagate('start', t), !0
    },
    _mouseDrag: function (t) {
      var i
      var s
      var n = this.originalMousePosition
      var a = this.axis
      var o = t.pageX - n.left || 0
      var r = t.pageY - n.top || 0
      var h = this._change[a]
    ...
    _updateRatio: function (e) {
      ...
      return this._isNumber(e.height)
        ...
        : this._isNumber(e.width) &&
          (e.height = e.width / this.aspectRatio), s === 'sw' &&
        ((e.left = t.left + (i.width - e.width)), (e.top = null)), s === 'nw' &&
        (
    ...
    _respectSize: function (e) {
      ...
      var i = this.axis
      var s = this._isNumber(e.width) && t.maxWidth && t.maxWidth < e.width
      var n = this._isNumber(e.height) && t.maxHeight && t.maxHeight < e.height
      var a = this._isNumber(e.width) && t.minWidth && t.minWidth > e.width
      var o = this._isNumber(e.height) && t.minHeight && t.minHeight > e.height
      var r = this.originalPosition.left + this.originalSize.width
      var h = this.position.top + this.size.height
      var l = /sw|nw|w/.test(i)
      var u = /nw|ne|n/.test(i)
    ...
    _propagate: function (t, i) {
      e.ui.plugin.call(this, t, [i, this.ui()]), t !== 'resize' &&
    ...
    stop: function (t) {
      ...
      var o = a && i._hasScroll(n[0], 'left') ? 0 : i.sizeDiff.height
    ...
    start: function () {
      ...
      var o
      var r
      var h = e(this).resizable('instance')
      var l = h.options
      var u = h.element
      var d = l.containment
      var c =
    ...
    resize: function (t) {
      ...
      var n
      var a
      var o = e(this).resizable('instance')
      var r = o.options
      var h = o.containerOffset
      var l = o.position
      var u = o._aspectRatio || t.shiftKey
      var d = { top: 0, left: 0 }
      var c = o.containerElement
      var p = !0
    ...
    stop: function () {
      ...
      var i = t.options
      var s = t.containerOffset
      var n = t.containerPosition
      var a = t.containerElement
      var o = e(t.helper)
      var r = o.offset()
      var h = o.outerWidth() - t.sizeDiff.width
      var l = o.outerHeight() - t.sizeDiff.height
      t._helper &&
        !i.animate &&
    ...
    resize: function (t, i) {
      ...
      e(n.alsoResize).each(function () {
        var t = e(this)
        var s = e(this).data('ui-resizable-alsoresize')
        var n = {}
        var a = t.parents(i.originalElement[0]).length
          ? ['width', 'height']
    ...
    start: function () {
      ...
      (t.ghost = t.originalElement.clone()), t.ghost
        ...
        .addClass(typeof i.ghost === 'string' ? i.ghost : ''), t.ghost.appendTo(
        t.helper
      )
    },
    resize: function () {
    ...
    resize: function () {
      ...
      var s = i.options
      var n = i.size
      var a = i.originalSize
      var o = i.originalPosition
      var r = i.axis
      var h = typeof s.grid === 'number' ? [s.grid, s.grid] : s.grid
      var l = h[0] || 1
      var u = h[1] || 1
      var d = Math.round((n.width - a.width) / l) * l
      var c = Math.round((n.height - a.height) / u) * u
      var p = a.width + d
      var f = a.height + c
      var m = s.maxWidth && p > s.maxWidth
      var g = s.maxHeight && f > s.maxHeight
      var v = s.minWidth && s.minWidth > p
      var y = s.minHeight && s.minHeight > f;
        ...
        if (
          (
            ...
            a &&
              ...
              this.placeholder[a === 1 ? 'next' : 'prev']()[0] !== n &&
          ...
          (a && a !== 'x') ||
            (o.left =
              ...
              (this.offsetParent[0] === this.document[0].body
                ? 0
                : this.offsetParent[0].scrollLeft)), (a && a !== 'y') ||
            (o.top =
              n.top -
              this.offset.parent.top -
              this.margins.top +
    ...
    _intersectsWith: function (e) {
      ...
      var i = t + this.helperProportions.width
      ...
      var u = this.offset.click.left
      var d = this.options.axis === 'x' || (s + l > r && h > s + l)
      var c = this.options.axis === 'y' || (t + u > a && o > t + u)
      var p = d && c
    ...
    _createHelper: function (t) {
      ...
      var s = e.isFunction(i.helper)
        ...
        : i.helper === 'clone' ? this.currentItem.clone() : this.currentItem
    ...
    _setContainment: function () {
      ...
      var n = this.options
      n.containment === 'parent' &&
        (n.containment = this.helper[0].parentNode), (n.containment ===
        'document' ||
        n.containment === 'window') &&
        (this.containment = [
    ...
    _create: function () {
      ...
      (this.prevShow = this.prevHide = e()), this.element
        ...
        (t.active = 0), this._processPanels(), t.active < 0 &&
    ...
    _destroy: function () {
      ...
      this.element
        ...
        .removeUniqueId()), this.options.heightStyle !== 'content' &&
        e.css('height', '')
    },
    _setOption: function (e, t) {
      return e === 'active'
    ...
    _keydown: function (t) {
      if (!t.altKey && !t.ctrlKey) {
        ...
        var n = this.headers.index(t.target)
        var a = !1
        switch (t.keyCode) {
          case i.RIGHT:
          case i.DOWN:
    ...
    _refresh: function () {
      ...
      (this.active = this._findActive(i.active)
        ...
        .each(function () {
          var t = e(this)
          var i = t.uniqueId().attr('id')
          var s = t.next()
          var n = s.uniqueId().attr('id')
        ...
        ? (
          ...
          this.element.siblings(':visible').each(function () {
            var i = e(this)
            var s = i.css('position')
            s !== 'absolute' && s !== 'fixed' && (t -= i.outerHeight(!0))
          }),
    ...
    _eventHandler: function (t) {
      ...
      var a = n[0] === s[0]
      var o = a && i.collapsible
      var r = o ? e() : n.next()
      var h = s.next()
      var l = { oldHeader: s, oldPanel: h, newHeader: o ? e() : n, newPanel: r }
    ...
    _toggle: function (t) {
      var i = t.newPanel
      var s = this.prevShow.length ? this.prevShow : t.oldPanel
      this.prevShow
        .add(this.prevHide)
    ...
    _animate: function (e, t, i) {
      ...
      return typeof d === 'number' && (a = d), typeof d === 'string' &&
        ...
        ? e.length
          ? (
            ...
            e.hide().animate(this.showProps, {
              ...
              complete: c,
              step: function (e, i) {
                (i.now = Math.round(e)), i.prop !== 'height'
                  ? h === 'content-box' && (r += i.now)
                  : o.options.heightStyle !== 'content' &&
    ...
    refresh: function () {
      ...
      var a = this.element.find(this.options.menus)
    ...
    focus: function (e, t) {
      var i, s
      this.blur(e, e && e.type === 'focus'), this._scrollIntoView(
        t
    ...
    _startOpening: function (e) {
      clearTimeout(this.timer), e.attr('aria-hidden') === 'true' &&
        (this.timer = this._delay(function () {
    ...
    _move: function (e, t, i) {
      ...
      this.active &&
        (s =
          e === 'first' || e === 'last'
            ? this.active
              [e === 'first' ? 'prevAll' : 'nextAll']('.ui-menu-item')
              .eq(-1)
    ...
    _setOption: function (e, t) {
      this._super(e, t), e === 'source' && this._initSource(), e ===
        'appendTo' && this.menu.element.appendTo(this._appendTo()), e === 'disabled' &&
        t &&
        this.xhr &&
        this.xhr.abort()
    },
    ...
    _searchTimeout: function (e) {
      clearTimeout(this.searching), (this.searching = this._delay(function () {
        ...
        var i = this.menu.element.is(':visible')
        var s = e.altKey || e.ctrlKey || e.metaKey || e.shiftKey;
        (!t || (t && !i && !s)) &&
    ...
    search: function (e, t) {
      return (e =
        e != null ? e : this._value()), (this.term = this._value()), e.length <
  ...
  var c
  var p = 'ui-button ui-widget ui-state-default ui-corner-all'
  var f =
  ...
  e.widget('ui.button', {
    ...
    _create: function () {
      this.element
        ...
        .bind('reset' + this.eventNamespace, m), typeof this.options.disabled !==
      'boolean'
      ...
      var t = this
      var i = this.options
      var s = this.type === 'checkbox' || this.type === 'radio'
      var n = s ? '' : 'ui-state-active'
      i.label === null &&
        (i.label =
          this.type === 'input'
    ...
    _determineButtonType: function () {
      ...
      (this.type = this.element.is('[type=checkbox]')
        ...
        : this.element.is('[type=radio]')
          ? 'radio'
          : this.element.is('input') ? 'input' : 'button'), this.type ===
    ...
    _setOption: function (e, t) {
      return this._super(e, t), e === 'disabled'
        ? (
    ...
    refresh: function () {
      ...
      t !== this.options.disabled && this._setOption('disabled', t), this.type ===
      'radio'
    ...
    _resetButton: function () {
      ...
      var i = e('<span></span>', this.document[0])
    ...
    _setOption: function (e, t) {
      e === 'disabled' && this.buttons.button('option', e, t), this._super(
        e,
        t
      )
    },
    refresh: function () {
      ...
      var i = this.element.find(this.options.items)
      var s = i.filter(':ui-button')
  ...
  e.extend(n.prototype, {
    ...
    _attachDatepicker: function (t, i) {
      var s, n, a;
      (s = t.nodeName.toLowerCase()), (n = s === 'div' || s === 'span'), t.id ||
        ((this.uuid += 1), (t.id = 'dp' + this.uuid)), (a = this._newInst(
        e(t),
        n
      )), (a.settings = e.extend({}, i || {})), s === 'input'
    ...
    _attachments: function (t, i) {
      ...
      i.append && i.append.remove(), o &&
        ...
        i.trigger.remove(), (s = this._get(i, 'showOn')), (s === 'focus' ||
        s === 'both') &&
        t.focus(this._showDatepicker), (s === 'button' || s === 'both') &&
        (
    ...
    _optionDatepicker: function (t, i, s) {
      ...
      var o
      var h
      var l = this._getInst(t)
      return arguments.length === 2 && typeof i === 'string'
        ? i === 'defaults'
          ? e.extend({}, e.datepicker._defaults)
          : l
            ? i === 'all' ? e.extend({}, l.settings) : this._get(l, i)
            : null
        : (
          (n = i || {}),
    ...
    _doKeyDown: function (t) {
      ...
      var o = !0
      var r = a.dpDiv.is('.ui-datepicker-rtl')
    ...
    _updateDatepicker: function (t) {
      ...
      var n = s[1]
      var a = 17
      var r = t.dpDiv.find('.' + this._dayOverClass + ' a')
    ...
    _checkOffset: function (t, i, s) {
      ...
      var a = t.dpDiv.outerHeight()
      var o = t.input ? t.input.outerWidth() : 0
      var r = t.input ? t.input.outerHeight() : 0
      var h =
    ...
    _checkExternalClick: function (t) {
      if (e.datepicker._curInst) {
        var i = e(t.target)
        var s = e.datepicker._getInst(i[0]);
      ...
      this._isDisabledDatepicker(n[0]) ||
        (
          this._adjustInstDate(
            a,
            i + (s === 'M' ? this._get(a, 'showCurrentAtPos') : 0),
            s
          ),
    ...
    _selectDate: function (t, i) {
      ...
      var n = e(t)
      var a = this._getInst(n[0]);
      (i = i != null ? i : this._formatDate(a)), a.input &&
    ...
    parseDate: function (t, i, s) {
      ...
      var r
      var h = 0
      var l = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff
      var u =
          typeof l !== 'string'
            ? l
            : new Date().getFullYear() % 100 + parseInt(l, 10)
      var d = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort
      var c = (s ? s.dayNames : null) || this._defaults.dayNames
      var p = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort
      var f = (s ? s.monthNames : null) || this._defaults.monthNames
      var m = -1
      var g = -1
      var v = -1
      var y = -1
      ...
      var x = function (e) {
        ...
        var s =
              e === '@'
                ? 14
                : e === '!' ? 20 : e === 'y' && t ? 4 : e === 'o' ? 3 : 2
        var n = e === 'y' ? s : 1
        var a = RegExp('^\\d{' + n + ',' + s + '}')
        var o = i.substring(h).match(a)
        if (!o) {
          throw 'Missing number at position ' + h
        }
        return (h += o[0].length), parseInt(o[0], 10)
      }
      var k = function (t, s, n) {
        var a = -1
        var o = e
    ...
    formatDate: function (e, t, i) {
      ...
      var a = (i ? i.dayNames : null) || this._defaults.dayNames
      var o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort
    ...
    _setDateFromField: function (e, t) {
      if (e.input.val() !== e.lastVal) {
        ...
        var s = (e.lastVal = e.input ? e.input.val() : null)
        var n = this._getDefaultDate(e)
        var a = n
          ...
          i == null || i === ''
            ...
            : typeof i === 'string'
              ...
              : typeof i === 'number'
                ? isNaN(i) ? s : n(i)
                : new Date(i.getTime())
      return (o = o && '' + o == 'Invalid Date' ? s : o), o &&
        (
          o.setHours(0),
          o.setMinutes(0),
          o.setSeconds(0),
    ...
    _setDate: function (e, t, i) {
      var s = !t
      var n = e.selectedMonth
      var a = e.selectedYear
    ...
    _generateHTML: function (e) {
      ...
      var Y = this._get(e, 'isRTL')
      var J = this._get(e, 'showButtonPanel')
      var B = this._get(e, 'hideIfNoPrevNext')
      var Q = this._get(e, 'navigationAsDateFormat')
      var K = this._getNumberOfMonths(e)
      var V = this._get(e, 'showCurrentAtPos')
      var q = this._get(e, 'stepMonths')
      var U = K[0] !== 1 || K[1] !== 1
      ...
      var X = this._getMinMaxDate(e, 'min')
      var $ = this._getMinMaxDate(e, 'max')
      var Z = e.drawMonth - V
      var et = e.drawYear
      if ((Z < 0 && ((Z += 12), et--), $)) {
        for (
        ...
        for (w = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
          ...
          for (
            M +=
              ...
              S +
              "'>" +
              (/all|left/.test(S) && k === 0 ? (Y ? a : s) : '') +
              (/all|right/.test(S) && k === 0 ? (Y ? s : a) : '') +
    ...
    _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
      ...
      var f
      var m
      var g = this._get(e, 'changeMonth')
      var v = this._get(e, 'changeYear')
      var y = this._get(e, 'showMonthAfterYear')
    ...
    _adjustInstDate: function (e, t, i) {
      var s = e.drawYear + (i === 'Y' ? t : 0)
      var n = e.drawMonth + (i === 'M' ? t : 0)
      var a =
          Math.min(e.selectedDay, this._getDaysInMonth(s, n)) +
          (i === 'D' ? t : 0)
      var o = this._restrictMinMax(
        e,
        this._daylightSavingAdjust(new Date(s, n, a))
      );
      (e.selectedDay = o.getDate()), (e.drawMonth = e.selectedMonth = o.getMonth()), (e.drawYear = e.selectedYear = o.getFullYear()), (i ===
        'M' ||
        i === 'Y') &&
    ...
    _restrictMinMax: function (e, t) {
      ...
      var s = this._getMinMaxDate(e, 'max')
      var n = i && i > t ? i : t
      return s && n > s ? s : n
    },
    ...
    _canAdjustMonth: function (e, t, i, s) {
      ...
      var a = this._daylightSavingAdjust(
    ...
    'ui.dialog',
    {
      ...
      _makeDraggable: function () {
        ...
        this.uiDialog.draggable({
          ...
          stop: function (n, a) {
            ...
            var r = a.offset.top - i.document.scrollTop();
            (s.position = {
              my: 'left top',
              at:
                'left' +
      ...
      _makeResizable: function () {
        ...
        var s = this.options
        var n = s.resizable
        var a = this.uiDialog.css('position')
        ...
        this.uiDialog
          .resizable({
            ...
            stop: function (n, a) {
              ...
              var r = o.left - i.document.scrollLeft()
              var h = o.top - i.document.scrollTop();
      ...
      _setOption: function (e, t) {
        ...
        var n = this.uiDialog
        e === 'dialogClass' &&
          n.removeClass(this.options.dialogClass).addClass(t), e !==
          'disabled' &&
          (
            this._super(e, t),
    ...
    _constrainedValue: function (e) {
      return void 0 === e && (e = this.options.value), (this.indeterminate =
        e === !1), typeof e !== 'number' && (e = 0), this.indeterminate
        ? !1
    ...
    _setOption: function (e, t) {
      e === 'max' && (t = Math.max(this.min, t)), e === 'disabled' &&
        this.element
          .toggleClass('ui-state-disabled', !!t)
          .attr('aria-disabled', t), this._super(e, t)
    },
    ...
    _move: function (e, t) {
      ...
      this.isOpen
        ...
        e === 'first' || e === 'last'
          ? i[e === 'first' ? 'prevAll' : 'nextAll'](n).eq(-1)
    ...
    _setOption: function (e, t) {
      e === 'icons' &&
        this.button
          ...
          .addClass(t.button), this._super(e, t), e === 'appendTo' &&
        this.menuWrap.appendTo(this._appendTo()), e === 'disabled' &&
        (
    ...
    _mouseDrag: function (e) {
      ...
      var i = this._normValueFromMouse(t)
    ...
    _normValueFromMouse: function (e) {
      ...
      return this.orientation === 'horizontal'
        ...
        ), (s = i / t), s > 1 && (s = 1), s < 0 && (s = 0), this.orientation ===
        'vertical' && (s = 1 - s), (n =
    ...
    _calculateNewMax: function () {
      ...
      var t = this._valueMin()
      var i = this.options.step
      var s = Math.floor(+(e - t).toFixed(this._precision()) / i) * i;
        ...
        ? this.handles.each(function (s) {
          (i =
              ...
              ((h.values(s) - h._valueMin()) /
                (h._valueMax() -
                  h._valueMin()))), (u[h.orientation === 'horizontal' ? 'left' : 'bottom'] = i + '%'), e(this).stop(1, 1)[l ? 'animate' : 'css'](u, r.animate), h.options.range === !0 && (h.orientation === 'horizontal' ? (s === 0 && h.range.stop(1, 1)[l ? 'animate' : 'css']({ left: i + '%' }, r.animate), s === 1 && h.range[l ? 'animate' : 'css']({ width: i - t + '%' }, { queue: !1, duration: r.animate })) : (s === 0 && h.range.stop(1, 1)[l ? 'animate' : 'css']({ bottom: i + '%' }, r.animate), s === 1 && h.range[l ? 'animate' : 'css']({ height: i - t + '%' }, { queue: !1, duration: r.animate }))), (t = i)
        })
        : (
          (s = this.value()),
          (n = this._valueMin()),
          (a = this._valueMax()),
          (i = a !== n ? 100 * ((s - n) / (a - n)) : 0),
          (u[this.orientation === 'horizontal' ? 'left' : 'bottom'] =
              i + '%'),
    ...
    _handleEvents: {
      keydown: function (t) {
        ...
        var n
        var a
        var o = e(t.target).data('ui-slider-handle-index')
        switch (t.keyCode) {
          case e.ui.keyCode.HOME:
          case e.ui.keyCode.END:
          case e.ui.keyCode.PAGE_UP:
    ...
    _value: function (e, t) {
      ...
      e !== '' &&
        (
          (i = this._parse(e)),
          i !== null && (t || (i = this._adjustValue(i)), (e = this._format(i)))
    ...
    _initialActive: function () {
      ...
      var i = this.options.collapsible
    ...
    _findNextTab: function (t, i) {
      ...
      for (
        ...
        e.inArray(s(), this.options.disabled) !== -1;
    ...
    _processTabs: function () {
      ...
      (this.tablist = this._getList()
        ...
        var a
        var o
        var r = e(s).uniqueId().attr('id')
        var h = e(s).closest('li')
        var l = h.attr('aria-controls')
        t._isLocal(s)
          ? (
            (n = s.hash),
            (o = n.substring(1)),
      ...
      t === 'fill'
        ? (
          ...
          this.element.siblings(':visible').each(function () {
            ...
            s !== 'absolute' && s !== 'fixed' && (i -= t.outerHeight(!0))
          }),
    ...
    _eventHandler: function (t) {
      ...
      var h = r ? e() : this._getPanelForTab(a)
      var l = s.length ? this._getPanelForTab(s) : e()
      var u = { oldTab: s, oldPanel: l, newTab: r ? e() : a, newPanel: h }
    ...
    _destroy: function () {
      this.xhr && this.xhr.abort(), this.element.removeClass(
        ...
        var t = e(this)
        var i = t.data('ui-tabs-aria-controls')
        i
    ...
    load: function (t, i) {
      ...
      var a = n.find('.ui-tabs-anchor')
      var o = this._getPanelForTab(n)
      var r = { tab: n, panel: o }
      var h = function (e, t) {
        t === 'abort' && s.panels.stop(!1, !0), n.removeClass(
          'ui-tabs-loading'
    ...
    _removeDescribedBy: function (t) {
      ...
      var s = (t.attr('aria-describedby') || '').split(/\s+/)
      var n = e.inArray(i, s)
      n !== -1 && s.splice(n, 1), t.removeData('ui-tooltip-id'), (s = e.trim(
        s.join(' ')
    ...
    open: function (t) {
      var i = this
      var s = e(t ? t.target : this.element).closest(this.options.items)
      s.length &&
    ...
    _open: function (t, i, s) {
      ...
      var r
      var h
      var l = e.extend({}, this.options.position)
      if (s) {
        if ((a = this._find(i))) {
    ...
    _registerCloseHandlers: function (t, i) {
      ...
      i[0] !== this.element[0] &&
        ...
        }), (t && t.type !== 'mouseover') || (s.mouseleave = 'close'), (t &&
        t.type !== 'focusin') ||
    ...
    close: function (t) {
      var i
      var s = this
      var n = e(t ? t.currentTarget : this.element)
      var a = this._find(n)
      return a
        ? (
          (i = a.tooltip),
  ...
  (e.effects = { effect: {} }), (function (e, t) {
    function i (e, t, i) {
      ...
      return e == null
        ...
        : (
          ...
          isNaN(e)
            ? t.def
            : s.mod ? (e + s.mod) % s.mod : e < 0 ? 0 : e > s.max ? s.max : e
        )
    }
    function s (i) {
      var s = l()
      ...
      return (i = i.toLowerCase()), f(h, function (e, a) {
        ...
        ? (n.join() === '0,0,0,0' && e.extend(n, a.transparent), s)
        : a[i]
    }
    function n (e, t, i) {
      return (i =
        (i + 1) %
        1), 6 * i < 1 ? e + 6 * (t - e) * i : 2 * i < 1 ? t : 3 * i < 2 ? e + 6 * (t - e) * (2 / 3 - i) : e
    }
    var a
    var o =
    ...
    var l = (e.Color = function (t, i, s, n) {
    ...
    (p.style.cssText =
      ...
      parse: function (n, o, r, h) {
        ...
        var c = e.type(n)
        var p = (this._rgba = [])
        return o !== t && ((n = [n, o, r, h]), (c = 'array')), c === 'string'
                  ...
                  : f(u, function (t, s) {
                    ...
                    f(s.props, function (e, t) {
                      ...
                      d[a][t.idx] = i(n[e], t, !0)
                          ...
                          e.inArray(null, d[a].slice(0, 3)) < 0 &&
          ...
          return r &&
            (
              ...
              f(a.props, function (e, i) {
                return r[i.idx] != null ? (s = r[i.idx] === o[i.idx]) : t
              })
            ), s
        }), s
      },
      ...
      transition: function (e, t) {
        ...
        var n = s._space()
        var a = u[n]
        var o = this.alpha() === 0 ? l('transparent') : this
      ...
      toRgbaString: function () {
        var t = 'rgba('
        var i = e.map(this._rgba, function (e, t) {
      ...
      toHslaString: function () {
        var t = 'hsla('
        var i = e.map(this.hsla(), function (e, t) {
          return e == null &&
              (e =
                t > 2
                  ? 1
                  : 0), t && t < 3 && (e = Math.round(100 * e) + '%'), e
        })
      ...
      (l.fn[s] = function (s) {
        ...
        var n
        var r = e.type(s)
        var d = r === 'array' || r === 'object' ? s : arguments
        var c = this[o].slice()
        return f(a, function (e, t) {
          var s = d[r === 'object' ? e : t.idx]
          s == null && (s = c[t.idx]), (c[t.idx] = i(s, t))
        ...
        l.fn[t] ||
          (l.fn[t] = function (n) {
            var a
            var o = e.type(n)
            var h = t === 'alpha' ? (this._hsla ? 'hsla' : 'rgba') : s
            var l = this[h]()
            var u = l[i.idx]
            return o === 'undefined'
              ? u
              : (
                o === 'function' && ((n = n.call(this, u)), (o = e.type(n))),
                n == null && i.empty
                  ? this
                  : (
                    o === 'string' &&
      ...
      f(i, function (t, i) {
        (e.cssHooks[i] = {
          set: function (t, n) {
            ...
            var o
            var r = ''
            if (n !== 'transparent' && (e.type(n) !== 'string' || (a = s(n)))) {
              if (((n = l(a || n)), !c.rgba && n._rgba[3] !== 1)) {
                for (
                  o = i === 'backgroundColor' ? t.parentNode : t;
    ...
    function t (t) {
      ...
      if (n && n.length && n[0] && n[n[0]]) {
        for (s = n.length; s--;) {
          (i = n[s]), typeof n[i] === 'string' && (a[e.camelCase(i)] = n[i])
        }
      } else {
        for (i in n) {
          typeof n[i] === 'string' && (a[i] = n[i])
        }
      }
      return a
    }
    ...
    e.each(
      ...
      function (t, i) {
        e.fx.step[i] = function (e) {
          ((e.end !== 'none' && !e.setAttr) || (e.pos === 1 && !e.setAttr)) &&
      ...
      return this.queue(function () {
        ...
        var o = e(this)
        var r = o.attr('class') || ''
        var l = h.children ? o.find('*').addBack() : o;
        (l = l.map(function () {
          var i = e(this)
    ...
    function t (t, i, s, n) {
      return e.isPlainObject(t) &&
        (
          (i = t),
          (t = t.effect)
        ), (t = { effect: t }), i == null && (i = {}), e.isFunction(i) && ((n = i), (s = null), (i = {})), (typeof i === 'number' || e.fx.speeds[i]) && ((n = s), (s = i), (i = {})), e.isFunction(s) && ((n = s), (s = null)), i && e.extend(t, i), (s = s || i.duration), (t.duration = e.fx.off ? 0 : typeof s === 'number' ? s : s in e.fx.speeds ? e.fx.speeds[s] : e.fx.speeds._default), (t.complete = n || i.complete), t
    }
    function i (t) {
      return !t || typeof t === 'number' || e.fx.speeds[t]
        ? !0
        : typeof t !== 'string' || e.effects.effect[t]
          ? e.isFunction(t) ? !0 : typeof t !== 'object' || t.effect ? !1 : !0
          : !0
    }
    e.extend(e.effects, {
      version: '1.11.4',
      save: function (e, t) {
        for (var i = 0; t.length > i; i++) {
          t[i] !== null && e.data(y + t[i], e[0].style[t[i]])
        }
      },
      ...
      createWrapper: function (t) {
        ...
        return t.wrap(s), (t[0] === a || e.contains(t[0], a)) &&
          e(a).focus(), (s = t.parent()), t.css('position') === 'static'
      ...
      effect: function () {
        ...
        var n = s.mode
        var a = s.queue
        var o = e.effects.effect[s.effect]
        return e.fx.off || !o
          ? n
    ...
    var h = /up|left|vertical|horizontal/
    var l = ['position', 'top', 'bottom', 'left', 'right', 'height', 'width']
    var u = e.effects.setMode(o, t.mode || 'hide')
    var d = t.direction || 'up'
    var c = r.test(d)
    var p = c ? 'height' : 'width'
    var f = c ? 'top' : 'left'
    var m = h.test(d)
    var g = {}
    var v = u === 'show'
    o.parent().is('.ui-effects-wrapper')
      ...
      queue: !1,
      complete: function () {
        u === 'hide' && o.hide(), e.effects.restore(
          o,
          l
    ...
    var h = e.effects.setMode(o, t.mode || 'effect')
    var l = h === 'hide'
    var u = h === 'show'
    var d = t.direction || 'up'
    var c = t.distance
    ...
    for (
      (u || l) && r.push('opacity'), e.effects.save(
        ...
        (c = o[v === 'top' ? 'outerHeight' : 'outerWidth']() / 3), u &&
        (
          (a = { opacity: 1 }),
          (a[v] = 0),
    ...
    var o = e(this)
    var r = ['position', 'top', 'bottom', 'left', 'right', 'height', 'width']
    var h = e.effects.setMode(o, t.mode || 'hide')
    var l = h === 'show'
    var u = t.direction || 'vertical'
    var d = u === 'vertical'
    var c = d ? 'height' : 'width'
    var p = d ? 'top' : 'left'
    var f = {}
    e.effects.save(o, r), o.show(), (s = e.effects
      .createWrapper(o)
      .css({ overflow: 'hidden' })), (n =
      o[0].tagName === 'IMG' ? s : o), (a = n[c]()), l &&
    ...
    var o = e.effects.setMode(n, t.mode || 'hide')
    var r = o === 'show'
    var h = t.direction || 'left'
    var l = h === 'up' || h === 'down' ? 'top' : 'left'
    var u = h === 'up' || h === 'left' ? 'pos' : 'neg'
    var d = { opacity: r ? 1 : 0 }
    e.effects.save(n, a), n.show(), e.effects.createWrapper(n), (s =
      t.distance || n[l === 'top' ? 'outerHeight' : 'outerWidth'](!0) / 2), r &&
      n.css('opacity', 0).css(l, u === 'pos' ? -s : s), (d[l] =
      (r ? (u === 'pos' ? '+=' : '-=') : u === 'pos' ? '-=' : '+=') +
      s), n.animate(d, {
      queue: !1,
      duration: t.duration,
      easing: t.easing,
      complete: function () {
        o === 'hide' && n.hide(), e.effects.restore(
          n,
          a
    ...
    var l
    var u
    var d = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3
    var c = d
    var p = e(this)
    var f = e.effects.setMode(p, t.mode || 'hide')
    var m = f === 'show'
    var g = p.show().css('visibility', 'hidden').offset()
    var v = Math.ceil(p.outerWidth() / c)
    var y = Math.ceil(p.outerHeight() / d)
    var b = []
    for (a = 0; d > a; a++) {
    ...
    var s = e(this)
    var n = e.effects.setMode(s, t.mode || 'toggle')
    s.animate(
      { opacity: n },
    ...
    var r = e.effects.setMode(a, t.mode || 'hide')
    var h = r === 'show'
    var l = r === 'hide'
    var u = t.size || 15
    var d = /([0-9]+)%/.exec(u)
    ...
    var a = e.effects.setMode(s, t.mode || 'show')
    var o = { backgroundColor: s.css('backgroundColor') }
    a === 'hide' && (o.opacity = 0), e.effects.save(s, n), s
      .show()
      ...
      .animate(o, {
        ...
        easing: t.easing,
        complete: function () {
          a === 'hide' && s.hide(), e.effects.restore(s, n), i()
        },
      })
    ...
    var f = t.restore || p !== 'effect'
    var m = t.scale || 'both'
    var g = t.origin || ['middle', 'center']
    ...
    p === 'show' && o.show(), (s = {
      ...
      : (
        (o.from = t.from || (p === 'show' ? b : s)),
        (o.to = t.to || (p === 'hide' ? b : s))
      ), (a = {
    ...
    var s = e(this)
    var n = e.extend(!0, {}, t)
    var a = e.effects.setMode(s, t.mode || 'effect')
    var o =
        parseInt(t.percent, 10) ||
        (parseInt(t.percent, 10) === 0 ? 0 : a === 'hide' ? 0 : 100)
    var r = t.direction || 'both'
    var h = t.origin
    var l = {
      height: s.height(),
      width: s.width(),
    ...
    (n.effect = 'size'), (n.queue = !1), (n.complete = i), a !== 'effect' &&
    ...
    var s = e(this)
    var n = e.effects.setMode(s, t.mode || 'hide')
    var a = n === 'hide'
    ...
    var s
    var n = e(this)
    var a = e.effects.setMode(n, t.mode || 'show')
    var o = a === 'show'
    var r = a === 'hide'
    var h = o || a === 'hide'
    var l = 2 * (t.times || 5) + (h ? 1 : 0)
    var u = t.duration / l
    var d = 0
    var c = n.queue()
    var p = c.length
    ...
    var o = e.effects.setMode(n, t.mode || 'effect')
    var r = t.direction || 'left'
    var h = t.distance || 20
    var l = t.times || 3
    var u = 2 * l + 1
    var d = Math.round(t.duration / u)
    var c = r === 'up' || r === 'down' ? 'top' : 'left'
    var p = r === 'up' || r === 'left'
    var f = {}
    var m = {}
    var g = {}
    ...
    var o = e.effects.setMode(n, t.mode || 'show')
    var r = o === 'show'
    var h = t.direction || 'left'
    var l = h === 'up' || h === 'down' ? 'top' : 'left'
    var u = h === 'up' || h === 'left'
    ...
    e.effects.save(n, a), n.show(), (s =
      t.distance ||
      n[l === 'top' ? 'outerHeight' : 'outerWidth'](
        !0
    ...
    var s = e(this)
    var n = e(t.to)
    var a = n.css('position') === 'fixed'
    var o = e('body')
    var r = a ? o.scrollTop() : 0
    var h = a ? o.scrollLeft() : 0
    var l = n.offset()
    var u = {
      top: l.top - r,
      left: l.left - h,
    ...
    var d = s.offset()
    var c = e("<div class='ui-effects-transfer'></div>")

  ...
  ((e = (function () {
    ...
    return function (t, o) {
      ...
      (n.defaults = {
        ...
        i(t).data('slick') || {}), (n.options = i.extend(
        {},
        n.defaults,
        o,
        s
      )), (n.currentSlide = n.options.initialSlide), (n.originalSettings =
        n.options), void 0 !== document.mozHidden
        ? (
          (n.hidden = 'mozHidden'),
        ...
        n.keyHandler,
        n
      )), (n.instanceUid = e++), (n.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/), n.registerBreakpoints(), n.init(
        !0
      )
    }
    ...
    var o = {}
    var s = this
    s.animateHeight(), !0 === s.options.rtl &&
    ...
    switch ((
      ...
      case 'previous':
        ...
        break
      case 'next':
        (s = o === 0 ? r.options.slidesToScroll : o), r.slideCount >
          r.options.slidesToShow && r.slideHandler(r.currentSlide + s, !1, t)
        break
      case 'index':
        var d =
    ...
    e.options.dots &&
      ...
      i(e.$slideTrack).children().off('click.slick', e.selectHandler), i(
      window
    ).off(
    ...
    i(t.$slider).hasClass('slick-initialized') ||
      (
        ...
        t.checkResponsive(!0),
        t.focusHandler()
      ), e && t.$slider.trigger('init', [t]), !0 === t.options.accessibility &&
      ...
      (
        e.$slides.not(e.$slideTrack.find('.slick-cloned')).each(function (t) {
          ...
          i(this).attr({
            ...
            tabindex: -1,
          }), s !== -1 && i(this).attr({ 'aria-describedby': 'slick-slide-control' + e.instanceUid + s })
        }),
        e.$dots
          .attr('role', 'tablist')
          .find('li')
    ...
    e.initArrowEvents(), e.initDotEvents(), e.initSlideEvents(), e.$list.on(
      ...
      e.$list.on('keydown.slick', e.keyHandler), !0 ===
      e.options.focusOnSelect &&
      i(e.$slideTrack).children().on('click.slick', e.selectHandler), i(
      window
    ).on(
      'orientationchange.slick.slick-' + e.instanceUid,
    ...
    if (
      ...
      for (
        ...
        r < 0 && (r = n.slideCount - 1), (t = (t = t.add(d.eq(r))).add(
          d.eq(l)
        )), r--, l++
      }
    }
    ...
    i.setPosition(), i.$slideTrack.css({ opacity: 1 }), i.$slider.removeClass(
      'slick-loading'
    ), i.initUI(), i.options.lazyLoad === 'progressive' &&
    ...
    o.unload(), !0 === t
      ...
      : o.$slideTrack
        .children(this.options.slide)
        .eq(i)
        .remove(), (o.$slides = o.$slideTrack.children(
      this.options.slide
    )), o.$slideTrack
      .children(this.options.slide)
      .detach(), o.$slideTrack.append(o.$slides), (o.$slidesCache =
      o.$slides), o.reinit()
    ...
    var o = this
    var s = {}
    !0 === o.options.rtl && (i = -i), (e =
      o.positionProp == 'left' ? Math.ceil(i) + 'px' : '0px'), (t =
      o.positionProp == 'top' ? Math.ceil(i) + 'px' : '0px'), (s[
      o.positionProp
    ...
    t.$slides.each(function (o, s) {
      (e =
        t.slideWidth *
        o *
        -1), !0 === t.options.rtl ? i(s).css({ position: 'relative', right: e, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 }) : i(s).css({ position: 'relative', left: e, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 })
    }), t.$slides
      .eq(t.currentSlide)
    ...
    var i = this
    i.setDimensions(), i.setHeight(), !1 === i.options.fade
      ? i.setCSS(i.getLeft(i.currentSlide))
      : i.setFade(), i.$slider.trigger('setPosition', [i])
  }), (e.prototype.setProps = function () {
    var i = this
    var e = document.body.style;
    (i.positionProp = !0 === i.options.vertical ? 'top' : 'left'), i.positionProp ===
    'top'
      ...
      (!0 === i.options.useCSS && (i.cssTransitions = !0)), i.options.fade &&
    ...
    return (i = s.touchObject.startX - s.touchObject.curX), (e =
      ...
      e,
      i
    )), (o = Math.round(180 * t / Math.PI)) < 0 && (o = 360 - Math.abs(o)), o <=
      45 && o >= 0
    ...
    void 0 !== i.originalEvent &&
      ...
      (e =
        i.originalEvent
          .touches[0]), (t.touchObject.startX = t.touchObject.curX =
      void 0 !== e
        ? e.pageX
        : i.clientX), (t.touchObject.startY = t.touchObject.curY =

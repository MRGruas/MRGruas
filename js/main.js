...
<<<<<<< HEAD
        ...
        if (o.length) {
          ...
          return (
            e("#header").length &&
              ...
              e("#header").hasClass("header-scrolled") || (a -= 20)),
            e("html, body").animate(
              { scrollTop: o.offset().top - a },
              1500,
              "easeInOutExpo"
            ),
            e(this).parents(".nav-menu").length &&
              (e(".nav-menu .menu-active").removeClass("menu-active"),
  ...
  l
    ...
    .each(function (o) {
      0 === o
        ...
        : n.append(
            "<li data-target='#introCarousel' data-slide-to='" + o + "'></li>"
          ),
        e(this).css(
          "background-image",
          "url('" +
    ...
    e(".carousel").swipe({
      swipe: function (o, a, t, i, l, n) {
        "left" == a && e(this).carousel("next"),
          "right" == a && e(this).carousel("prev");
      },
  ...
  var s = e(".portfolio-container").isotope({
    itemSelector: ".portfolio-item",
    layoutMode: "fitRows",
  });
  e("#portfolio-flters li").on("click", function () {
    e("#portfolio-flters li").removeClass("filter-active"),
      e(this).addClass("filter-active"),
      s.isotope({ filter: e(this).data("filter") });
  }),

...
<<<<<<< HEAD
	var methods = (function () {
		...
		var c = {
			...
			ios = (function () {
				const newLocal = /^(?![\w\W]*Windows Phone)[\w\W]*(iPhone|iPad|iPod)/i;
				var ios = newLocal.test(navigator.userAgent);
				if (ios) {
...
=======
  var methods = (function () {
    ...
    var unprefixedPointerEvents = (function () {
      return (!!w.PointerEvent)
    })()
    var toggleMenuClasses = function ($menu, o, add) {
      var classes = c.menuClass
      var method
      if (o.cssArrows) {
        classes += ' ' + c.menuArrowClass
    ...
    return {
      ...
      hide: function (instant) {
        if (this.length) {
          ...
          var $ul = $this.find('li.' + o.hoverClass).add(this).not(not).removeClass(o.hoverClass).children(o.popUpSelector)
